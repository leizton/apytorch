...
c10::optional<DynamicLayer> maybeCurrentDynamicLayer();
...
c10::optional<size_t> findAliasedOutput(const FunctionSchema& schema, const int64_t immutable_input);
...
int64_t pushDynamicLayer(DynamicLayer&& layer);
