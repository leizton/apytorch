...
TORCH_LIBRARY(aten, m) {
  ...
  m.def("_assert_tensor_metadata(Tensor a, SymInt[]? size=None, SymInt[]? stride=None, ScalarType? dtype=None) -> ()", tags_0);
  ...
  m.def("dropout(Tensor input, float p, bool train) -> Tensor", tags_2);
  m.def("dropout_(Tensor(a!) self, float p, bool train) -> Tensor(a!)", tags_2);
  m.def("feature_dropout(Tensor input, float p, bool train) -> Tensor", tags_2);
  m.def("feature_dropout_(Tensor(a!) self, float p, bool train) -> Tensor(a!)", tags_2);
  m.def("alpha_dropout(Tensor input, float p, bool train) -> Tensor", tags_2);
  m.def("alpha_dropout_(Tensor(a!) self, float p, bool train) -> Tensor(a!)", tags_2);
  m.def("feature_alpha_dropout(Tensor input, float p, bool train) -> Tensor", tags_2);
  m.def("feature_alpha_dropout_(Tensor(a!) self, float p, bool train) -> Tensor(a!)", tags_2);
  const std::vector<at::Tag> tags_5 = {at::Tag::core, at::Tag::pointwise, at::Tag::pt2_compliant_tag};
  m.def("abs(Tensor self) -> Tensor", tags_5);
  ...
  m.def("conj_physical(Tensor self) -> Tensor", tags_4);
  ...
  m.def("acos(Tensor self) -> Tensor", tags_5);
  ...
  const std::vector<at::Tag> tags_6 = {at::Tag::core, at::Tag::pt2_compliant_tag};
  m.def("avg_pool1d(Tensor self, int[1] kernel_size, int[1] stride=[], int[1] padding=0, bool ceil_mode=False, bool count_include_pad=True) -> Tensor", tags_6);
  m.def("adaptive_avg_pool1d(Tensor self, int[1] output_size) -> Tensor", tags_6);
  ...
  m.def("add.Scalar(Tensor self, Scalar other, Scalar alpha=1) -> Tensor", tags_5);
  ...
  const std::vector<at::Tag> tags_7 = {at::Tag::data_dependent_output, at::Tag::pt2_compliant_tag};
  m.def("allclose(Tensor self, Tensor other, float rtol=1e-05, float atol=1e-08, bool equal_nan=False) -> bool", tags_7);
  m.def("any.dim(Tensor self, int dim, bool keepdim=False) -> Tensor", tags_6);
  m.def("any.dims(Tensor self, int[]? dim=None, bool keepdim=False) -> Tensor", tags_6);
  ...
  m.def("arange.start_step(Scalar start, Scalar end, Scalar step=1, *, ScalarType? dtype=None, Layout? layout=None, Device? device=None, bool? pin_memory=None) -> Tensor", tags_6);
  ...
  m.def("asinh(Tensor self) -> Tensor", tags_5);
  ...
  m.def("atanh(Tensor self) -> Tensor", tags_5);
  ...
  m.def("as_strided(Tensor(a) self, SymInt[] size, SymInt[] stride, SymInt? storage_offset=None) -> Tensor(a)", tags_6);
  m.def("as_strided_(Tensor(a!) self, SymInt[] size, SymInt[] stride, SymInt? storage_offset=None) -> Tensor(a!)", tags_1);
  m.def("asin(Tensor self) -> Tensor", tags_5);
  ...
  m.def("atan(Tensor self) -> Tensor", tags_5);
  ...
  m.def("atleast_1d(Tensor self) -> Tensor", tags_0);
  m.def("atleast_1d.Sequence(Tensor[] tensors) -> Tensor[]", tags_0);
  m.def("atleast_2d(Tensor self) -> Tensor", tags_0);
  m.def("atleast_2d.Sequence(Tensor[] tensors) -> Tensor[]", tags_0);
  m.def("atleast_3d(Tensor self) -> Tensor", tags_0);
  ...
  m.def("batch_norm(Tensor input, Tensor? weight, Tensor? bias, Tensor? running_mean, Tensor? running_var, bool training, float momentum, float eps, bool cudnn_enabled) -> Tensor", tags_0);
  ...
  m.def("_batch_norm_impl_index(Tensor input, Tensor? weight, Tensor? bias, Tensor? running_mean, Tensor? running_var, bool training, float momentum, float eps, bool cudnn_enabled) -> (Tensor, Tensor, Tensor, Tensor, int)", tags_0);
  ...
  const std::vector<at::Tag> tags_8 = {at::Tag::dynamic_output_shape, at::Tag::pt2_compliant_tag};
  m.def("bincount(Tensor self, Tensor? weights=None, int minlength=0) -> Tensor", tags_8);
  m.def("bitwise_not(Tensor self) -> Tensor", tags_5);
  ...
  m.def("logical_and(Tensor self, Tensor other) -> Tensor", tags_5);
  ...
  m.def("logical_or(Tensor self, Tensor other) -> Tensor", tags_5);
  ...
  m.def("bmm(Tensor self, Tensor mat2) -> Tensor", tags_6);
  ...
  m.def("cat(Tensor[] tensors, int dim=0) -> Tensor", tags_6);
  ...
  m.def("ceil(Tensor self) -> Tensor", tags_5);
  ...
  m.def("unsafe_chunk(Tensor self, int chunks, int dim=0) -> Tensor[]", tags_0);
  ...
  m.def("clamp(Tensor self, Scalar? min=None, Scalar? max=None) -> Tensor", tags_5);
  m.def("clamp.Tensor(Tensor self, Tensor? min=None, Tensor? max=None) -> Tensor", tags_5);
  ...
  m.def("constant_pad_nd(Tensor self, SymInt[] pad, Scalar value=0) -> Tensor", tags_6);
  m.def("contiguous(Tensor(a) self, *, MemoryFormat memory_format=contiguous_format) -> Tensor(a)", tags_0);
  m.def("convolution(Tensor input, Tensor weight, Tensor? bias, SymInt[] stride, SymInt[] padding, SymInt[] dilation, bool transposed, SymInt[] output_padding, SymInt groups) -> Tensor", tags_6);
  m.def("convolution_backward(Tensor grad_output, Tensor input, Tensor weight, SymInt[]? bias_sizes, SymInt[] stride, SymInt[] padding, SymInt[] dilation, bool transposed, SymInt[] output_padding, SymInt groups, bool[3] output_mask) -> (Tensor, Tensor, Tensor)", tags_6);
  ...
  m.def("copy(Tensor self, Tensor src, bool non_blocking=False) -> Tensor", tags_6);
  ...
  m.def("cumsum(Tensor self, int dim, *, ScalarType? dtype=None) -> Tensor", tags_6);
  ...
  m.def("_ctc_loss(Tensor log_probs, Tensor targets, int[] input_lengths, int[] target_lengths, int blank=0, bool zero_infinity=False) -> (Tensor, Tensor)", tags_8);
  m.def("_ctc_loss.Tensor(Tensor log_probs, Tensor targets, Tensor input_lengths, Tensor target_lengths, int blank=0, bool zero_infinity=False) -> (Tensor, Tensor)", tags_8);
  ...
  m.def("diagonal(Tensor(a) self, int offset=0, int dim1=0, int dim2=1) -> Tensor(a)", tags_6);
  ...
  m.def("div.Tensor(Tensor self, Tensor other) -> Tensor", tags_5);
  ...
  m.def("div.Tensor_mode(Tensor self, Tensor other, *, str? rounding_mode) -> Tensor", tags_5);
  ...
  m.def("div.Scalar(Tensor self, Scalar other) -> Tensor", tags_5);
  m.def("div_.Scalar(Tensor(a!) self, Scalar other) -> Tensor(a!)", tags_4);
  m.def("div.Scalar_mode(Tensor self, Scalar other, *, str? rounding_mode) -> Tensor", tags_5);
  ...
  m.def("embedding(Tensor weight, Tensor indices, SymInt padding_idx=-1, bool scale_grad_by_freq=False, bool sparse=False) -> Tensor", tags_6);
  ...
  m.def("embedding_dense_backward(Tensor grad_output, Tensor indices, SymInt num_weights, SymInt padding_idx, bool scale_grad_by_freq) -> Tensor", tags_6);
  ...
  m.def("_embedding_bag(Tensor weight, Tensor indices, Tensor offsets, bool scale_grad_by_freq=False, int mode=0, bool sparse=False, Tensor? per_sample_weights=None, bool include_last_offset=False, int padding_idx=-1) -> (Tensor, Tensor, Tensor, Tensor)", tags_6);
  ...
  m.def("empty.memory_format(SymInt[] size, *, ScalarType? dtype=None, Layout? layout=None, Device? device=None, bool? pin_memory=None, MemoryFormat? memory_format=None) -> Tensor", tags_6);
  ...
  const std::vector<at::Tag> tags_9 = {at::Tag::core, at::Tag::inplace_view, at::Tag::pt2_compliant_tag};
  m.def("resize_(Tensor(a!) self, SymInt[] size, *, MemoryFormat? memory_format=None) -> Tensor(a!)", tags_9);
  ...
  m.def("empty_strided(SymInt[] size, SymInt[] stride, *, ScalarType? dtype=None, Layout? layout=None, Device? device=None, bool? pin_memory=None) -> Tensor", tags_6);
  m.def("erf(Tensor self) -> Tensor", tags_5);
  ...
  m.def("exp(Tensor self) -> Tensor", tags_5);
  ...
  m.def("expm1(Tensor self) -> Tensor", tags_5);
  m.def("expm1_(Tensor(a!) self) -> Tensor(a!)", tags_4);
  m.def("expm1.out(Tensor self, *, Tensor(a!) out) -> Tensor(a!)", tags_4);
  m.def("expand(Tensor(a) self, SymInt[] size, *, bool implicit=False) -> Tensor(a)", tags_6);
  ...
  m.def("fill.Scalar(Tensor self, Scalar value) -> Tensor", tags_6);
  ...
  m.def("floor(Tensor self) -> Tensor", tags_5);
  ...
  m.def("full(SymInt[] size, Scalar fill_value, *, ScalarType? dtype=None, Layout? layout=None, Device? device=None, bool? pin_memory=None) -> Tensor", tags_6);
  m.def("full.out(SymInt[] size, Scalar fill_value, *, Tensor(a!) out) -> Tensor(a!)", tags_0);
  m.def("full_like(Tensor self, Scalar fill_value, *, ScalarType? dtype=None, Layout? layout=None, Device? device=None, bool? pin_memory=None, MemoryFormat? memory_format=None) -> Tensor", tags_0);
  ...
  m.def("grid_sampler_2d(Tensor input, Tensor grid, int interpolation_mode, int padding_mode, bool align_corners) -> Tensor", tags_6);
  ...
  m.def("native_group_norm(Tensor input, Tensor? weight, Tensor? bias, SymInt N, SymInt C, SymInt HxW, int group, float eps) -> (Tensor, Tensor, Tensor)", tags_6);
  m.def("native_group_norm_backward(Tensor grad_out, Tensor input, Tensor mean, Tensor rstd, Tensor? weight, SymInt N, SymInt C, SymInt HxW, int group, bool[3] output_mask) -> (Tensor, Tensor, Tensor)", tags_6);
  m.def("_fft_r2c(Tensor self, int[] dim, int normalization, bool onesided) -> Tensor", tags_0);
  ...
  const std::vector<at::Tag> tags_10 = {at::Tag::core, at::Tag::dynamic_output_shape, at::Tag::pt2_compliant_tag};
  m.def("index.Tensor(Tensor self, Tensor?[] indices) -> Tensor", tags_10);
  ...
  m.def("index_put(Tensor self, Tensor?[] indices, Tensor values, bool accumulate=False) -> Tensor", tags_6);
  ...
  m.def("isnan(Tensor self) -> Tensor", tags_5);
  ...
  m.def("native_layer_norm(Tensor input, SymInt[] normalized_shape, Tensor? weight, Tensor? bias, float eps) -> (Tensor, Tensor, Tensor)", tags_6);
  m.def("native_layer_norm_backward(Tensor grad_out, Tensor input, SymInt[] normalized_shape, Tensor mean, Tensor rstd, Tensor? weight, Tensor? bias, bool[3] output_mask) -> (Tensor, Tensor, Tensor)", tags_6);
  ...
  m.def("_cslt_sparse_mm(Tensor compressed_A, Tensor dense_B, Tensor? bias=None, Tensor? alpha=None, ScalarType? out_dtype=None, bool transpose_result=False, int alg_id=0) -> Tensor", tags_0);
  ...
  m.def("_log_softmax(Tensor self, int dim, bool half_to_float) -> Tensor", tags_6);
  ...
  m.def("max.dim(Tensor self, int dim, bool keepdim=False) -> (Tensor values, Tensor indices)", tags_6);
  ...
  m.def("amax(Tensor self, int[1] dim=[], bool keepdim=False) -> Tensor", tags_6);
  ...
  m.def("mean(Tensor self, *, ScalarType? dtype=None) -> Tensor", tags_6);
  m.def("mean.dim(Tensor self, int[1]? dim, bool keepdim=False, *, ScalarType? dtype=None) -> Tensor", tags_6);
  ...
  m.def("min.dim(Tensor self, int dim, bool keepdim=False) -> (Tensor values, Tensor indices)", tags_6);
  ...
  m.def("amin(Tensor self, int[1] dim=[], bool keepdim=False) -> Tensor", tags_6);
  ...
  m.def("mm(Tensor self, Tensor mat2) -> Tensor", tags_6);
  ...
  m.def("mul.Tensor(Tensor self, Tensor other) -> Tensor", tags_5);
  ...
  m.def("mul.Scalar(Tensor self, Scalar other) -> Tensor", tags_5);
  ...
  const std::vector<at::Tag> tags_11 = {at::Tag::pt2_compliant_tag, at::Tag::view_copy};
  m.def("narrow_copy(Tensor self, int dim, SymInt start, SymInt length) -> Tensor", tags_11);
  ...
  m.def("_native_batch_norm_legit(Tensor input, Tensor? weight, Tensor? bias, Tensor(a!) running_mean, Tensor(b!) running_var, bool training, float momentum, float eps) -> (Tensor, Tensor, Tensor)", tags_6);
  m.def("_native_batch_norm_legit_no_training(Tensor input, Tensor? weight, Tensor? bias, Tensor running_mean, Tensor running_var, float momentum, float eps) -> (Tensor, Tensor, Tensor)", tags_6);
  ...
  m.def("_native_batch_norm_legit.no_stats(Tensor input, Tensor? weight, Tensor? bias, bool training, float momentum, float eps) -> (Tensor, Tensor, Tensor)", tags_6);
  ...
  m.def("_cdist_forward(Tensor x1, Tensor x2, float p, int? compute_mode) -> Tensor", tags_6);
  ...
  m.def("_pdist_forward(Tensor self, float p=2) -> Tensor", tags_6);
  ...
  m.def("permute(Tensor(a) self, int[] dims) -> Tensor(a)", tags_6);
  ...
  m.def("pixel_shuffle(Tensor self, int upscale_factor) -> Tensor", tags_6);
  ...
  m.def("rad2deg(Tensor self) -> Tensor", tags_0);
  m.def("rad2deg_(Tensor(a!) self) -> Tensor(a!)", tags_0);
  m.def("rad2deg.out(Tensor self, *, Tensor(a!) out) -> Tensor(a!)", tags_0);
  ...
  m.def("scalar_tensor(Scalar s, *, ScalarType? dtype=None, Layout? layout=None, Device? device=None, bool? pin_memory=None) -> Tensor", tags_6);
  ...
  m.def("repeat(Tensor self, SymInt[] repeats) -> Tensor", tags_6);
  m.def("repeat_interleave.Tensor(Tensor repeats, *, SymInt? output_size=None) -> Tensor", tags_8);
  ...
  m.def("round(Tensor self) -> Tensor", tags_5);
  ...
  m.def("rrelu(Tensor self, Scalar lower=0.125, Scalar upper=0.3333333333333333, bool training=False, Generator? generator=None) -> Tensor", tags_2);
  ...
  m.def("relu(Tensor self) -> Tensor", tags_5);
  m.def("relu_(Tensor(a!) self) -> Tensor(a!)", tags_4);
  m.def("relu6(Tensor self) -> Tensor", tags_0);
  ...
  m.def("gelu(Tensor self, *, str approximate='none') -> Tensor", tags_5);
  ...
  m.def("hardshrink(Tensor self, Scalar lambd=0.5) -> Tensor", tags_0);
  ...
  m.def("rsqrt(Tensor self) -> Tensor", tags_5);
  ...
  m.def("select.int(Tensor(a) self, int dim, SymInt index) -> Tensor(a)", tags_6);
  ...
  m.def("selu(Tensor self) -> Tensor", tags_0);
  m.def("selu_(Tensor(a!) self) -> Tensor(a!)", tags_0);
  m.def("celu(Tensor self, Scalar alpha=1.0) -> Tensor", tags_0);
  ...
  m.def("mish(Tensor self) -> Tensor", tags_0);
  ...
  m.def("sigmoid(Tensor self) -> Tensor", tags_5);
  ...
  m.def("sin(Tensor self) -> Tensor", tags_5);
  ...
  m.def("sinh(Tensor self) -> Tensor", tags_5);
  ...
  m.def("sym_size.int(Tensor self, int dim) -> SymInt", tags_6);
  m.def("sym_numel(Tensor self) -> SymInt", tags_6);
  m.def("sym_storage_offset(Tensor self) -> SymInt", tags_6);
  m.def("slice.Tensor(Tensor(a) self, int dim=0, SymInt? start=None, SymInt? end=None, SymInt step=1) -> Tensor(a)", tags_6);
  ...
  const std::vector<at::Tag> tags_12 = {at::Tag::core, at::Tag::pt2_compliant_tag, at::Tag::view_copy};
  m.def("slice_scatter(Tensor self, Tensor src, int dim=0, SymInt? start=None, SymInt? end=None, SymInt step=1) -> Tensor", tags_12);
  m.def("select_scatter(Tensor self, Tensor src, int dim, SymInt index) -> Tensor", tags_6);
  ...
  m.def("_softmax(Tensor self, int dim, bool half_to_float) -> Tensor", tags_6);
  ...
  m.def("split_with_sizes(Tensor(a -> *) self, SymInt[] split_sizes, int dim=0) -> Tensor(a)[]", tags_6);
  ...
  m.def("squeeze.dim(Tensor(a) self, int dim) -> Tensor(a)", tags_6);
  m.def("squeeze.dimname(Tensor(a) self, Dimname dim) -> Tensor(a)", tags_0);
  m.def("squeeze.dims(Tensor(a) self, int[] dim) -> Tensor(a)", tags_6);
  ...
  m.def("stft(Tensor self, int n_fft, int? hop_length=None, int? win_length=None, Tensor? window=None, bool normalized=False, bool? onesided=None, bool? return_complex=None) -> Tensor", tags_0);
  m.def("stft.center(Tensor self, int n_fft, int? hop_length=None, int? win_length=None, Tensor? window=None, bool center=True, str pad_mode=\"reflect\", bool normalized=False, bool? onesided=None, bool? return_complex=None) -> Tensor", tags_0);
  ...
  m.def("sym_stride.int(Tensor self, int dim) -> SymInt", tags_6);
  m.def("sum(Tensor self, *, ScalarType? dtype=None) -> Tensor", tags_0);
  m.def("sum.dim_IntList(Tensor self, int[1]? dim, bool keepdim=False, *, ScalarType? dtype=None) -> Tensor", tags_6);
  ...
  m.def("sqrt(Tensor self) -> Tensor", tags_5);
  ...
  m.def("prod(Tensor self, *, ScalarType? dtype=None) -> Tensor", tags_6);
  m.def("prod.dim_int(Tensor self, int dim, bool keepdim=False, *, ScalarType? dtype=None) -> Tensor", tags_6);
  ...
  m.def("threshold(Tensor self, Scalar threshold, Scalar value) -> Tensor", tags_0);
  ...
  m.def("one_hot(Tensor self, int num_classes=-1) -> Tensor", tags_8);
  m.def("flip(Tensor self, int[] dims) -> Tensor", tags_6);
  m.def("fliplr(Tensor self) -> Tensor", tags_0);
  m.def("flipud(Tensor self) -> Tensor", tags_0);
  m.def("roll(Tensor self, SymInt[1] shifts, int[1] dims=[]) -> Tensor", tags_6);
  ...
  m.def("_nested_view_from_buffer_copy(Tensor self, Tensor nested_size, Tensor nested_strides, Tensor offsets) -> Tensor", tags_11);
  ...
  m.def("trunc(Tensor self) -> Tensor", tags_5);
  ...
  m.def("unique_dim(Tensor self, int dim, bool sorted=True, bool return_inverse=False, bool return_counts=False) -> (Tensor, Tensor, Tensor)", tags_8);
  m.def("unique_consecutive(Tensor self, bool return_inverse=False, bool return_counts=False, int? dim=None) -> (Tensor, Tensor, Tensor)", tags_8);
  m.def("unique_dim_consecutive(Tensor self, int dim, bool return_inverse=False, bool return_counts=False) -> (Tensor, Tensor, Tensor)", tags_8);
  m.def("_unique2(Tensor self, bool sorted=True, bool return_inverse=False, bool return_counts=False) -> (Tensor, Tensor, Tensor)", tags_8);
  m.def("_unsafe_view(Tensor self, SymInt[] size) -> Tensor", tags_0);
  m.def("unsqueeze(Tensor(a) self, int dim) -> Tensor(a)", tags_6);
  ...
  m.def("var.dim(Tensor self, int[1]? dim, bool unbiased=True, bool keepdim=False) -> Tensor", tags_6);
  m.def("var.correction(Tensor self, int[1]? dim=None, *, Scalar? correction=None, bool keepdim=False) -> Tensor", tags_6);
  ...
  m.def("where.self(Tensor condition, Tensor self, Tensor other) -> Tensor", tags_5);
  ...
  m.def("clone(Tensor self, *, MemoryFormat? memory_format=None) -> Tensor", tags_5);
  ...
  m.def("sub.Tensor(Tensor self, Tensor other, *, Scalar alpha=1) -> Tensor", tags_5);
  m.def("sub_.Tensor(Tensor(a!) self, Tensor other, *, Scalar alpha=1) -> Tensor(a!)", tags_4);
  m.def("sub.Scalar(Tensor self, Scalar other, Scalar alpha=1) -> Tensor", tags_5);
  ...
  m.def("addmm(Tensor self, Tensor mat1, Tensor mat2, *, Scalar beta=1, Scalar alpha=1) -> Tensor", tags_6);
  ...
  m.def("_scaled_mm(Tensor self, Tensor mat2, *, Tensor? bias=None, ScalarType? out_dtype=None, Tensor? scale_a=None, Tensor? scale_b=None, Tensor? scale_result=None, bool use_fast_accum=False) -> (Tensor, Tensor)", tags_0);
  m.def("_scaled_mm.out(Tensor self, Tensor mat2, *, Tensor? bias=None, ScalarType? out_dtype=None, Tensor? scale_a=None, Tensor? scale_b=None, Tensor? scale_result=None, bool use_fast_accum=False, Tensor(a!) out, Tensor(b!) out_amax) -> (Tensor(a!), Tensor(b!))", tags_0);
  ...
  m.def("mkldnn_reorder_conv3d_weight(Tensor self, SymInt[3] padding=0, SymInt[3] stride=1, SymInt[3] dilation=1, SymInt groups=1) -> Tensor", tags_0);
  ...
  m.def("_to_copy(Tensor self, *, ScalarType? dtype=None, Layout? layout=None, Device? device=None, bool? pin_memory=None, bool non_blocking=False, MemoryFormat? memory_format=None) -> Tensor", tags_6);
  ...
  m.def("cartesian_prod(Tensor[] tensors) -> Tensor", tags_0);
  m.def("combinations(Tensor self, int r=2, bool with_replacement=False) -> Tensor", tags_0);
  m.def("item(Tensor self) -> Scalar", tags_7);
  ...
  m.def("can_cast(ScalarType from, ScalarType to) -> bool", tags_0);
  m.def("promote_types(ScalarType type1, ScalarType type2) -> ScalarType", tags_0);
  const std::vector<at::Tag> tags_13 = {at::Tag::core, at::Tag::data_dependent_output, at::Tag::pt2_compliant_tag};
  m.def("_local_scalar_dense(Tensor self) -> Scalar", tags_13);
  ...
  m.def("lift_fresh_copy(Tensor self) -> Tensor", tags_11);
  ...
  m.def("masked_scatter(Tensor self, Tensor mask, Tensor source) -> Tensor", tags_0);
  ...
  m.def("view(Tensor(a) self, SymInt[] size) -> Tensor(a)", tags_6);
  ...
  m.def("scatter.src(Tensor self, int dim, Tensor index, Tensor src) -> Tensor", tags_6);
  ...
  m.def("scatter.value(Tensor self, int dim, Tensor index, Scalar value) -> Tensor", tags_6);
  ...
  m.def("scatter_add(Tensor self, int dim, Tensor index, Tensor src) -> Tensor", tags_6);
  ...
  m.def("scatter_reduce.two(Tensor self, int dim, Tensor index, Tensor src, str reduce, *, bool include_self=True) -> Tensor", tags_6);
  ...
  m.def("bitwise_and.Scalar(Tensor self, Scalar other) -> Tensor", tags_5);
  m.def("bitwise_and.Scalar_Tensor(Scalar self, Tensor other) -> Tensor", tags_4);
  m.def("bitwise_and.Tensor(Tensor self, Tensor other) -> Tensor", tags_5);
  ...
  m.def("bitwise_or.Scalar(Tensor self, Scalar other) -> Tensor", tags_5);
  m.def("bitwise_or.Scalar_Tensor(Scalar self, Tensor other) -> Tensor", tags_4);
  m.def("bitwise_or.Tensor(Tensor self, Tensor other) -> Tensor", tags_5);
  ...
  m.def("bitwise_xor.Scalar(Tensor self, Scalar other) -> Tensor", tags_5);
  m.def("bitwise_xor.Scalar_Tensor(Scalar self, Tensor other) -> Tensor", tags_4);
  m.def("bitwise_xor.Tensor(Tensor self, Tensor other) -> Tensor", tags_5);
  ...
  m.def("ne.Scalar(Tensor self, Scalar other) -> Tensor", tags_5);
  m.def("ne.Tensor_out(Tensor self, Tensor other, *, Tensor(a!) out) -> Tensor(a!)", tags_4);
  m.def("ne.Tensor(Tensor self, Tensor other) -> Tensor", tags_5);
  ...
  m.def("le.Scalar(Tensor self, Scalar other) -> Tensor", tags_5);
  m.def("le.Tensor_out(Tensor self, Tensor other, *, Tensor(a!) out) -> Tensor(a!)", tags_4);
  m.def("le.Tensor(Tensor self, Tensor other) -> Tensor", tags_5);
  ...
  m.def("gt.Scalar(Tensor self, Scalar other) -> Tensor", tags_5);
  m.def("gt.Tensor_out(Tensor self, Tensor other, *, Tensor(a!) out) -> Tensor(a!)", tags_4);
  m.def("gt.Tensor(Tensor self, Tensor other) -> Tensor", tags_5);
  ...
  m.def("lt.Scalar(Tensor self, Scalar other) -> Tensor", tags_5);
  m.def("lt.Tensor_out(Tensor self, Tensor other, *, Tensor(a!) out) -> Tensor(a!)", tags_4);
  m.def("lt.Tensor(Tensor self, Tensor other) -> Tensor", tags_5);
  ...
  m.def("index_select(Tensor self, int dim, Tensor index) -> Tensor", tags_6);
  ...
  m.def("masked_select.out(Tensor self, Tensor mask, *, Tensor(a!) out) -> Tensor(a!)", tags_8);
  m.def("masked_select(Tensor self, Tensor mask) -> Tensor", tags_8);
  m.def("masked_select_backward(Tensor grad, Tensor input, Tensor mask) -> Tensor", tags_0);
  m.def("nonzero.out(Tensor self, *, Tensor(a!) out) -> Tensor(a!)", tags_8);
  m.def("nonzero(Tensor self) -> Tensor", tags_10);
  m.def("nonzero_static.out(Tensor self, *, int size, int fill_value=-1, Tensor(a!) out) -> Tensor(a!)", tags_0);
  m.def("nonzero_static(Tensor self, *, int size, int fill_value=-1) -> Tensor", tags_0);
  m.def("nonzero_numpy(Tensor self) -> Tensor[]", tags_0);
  m.def("argwhere(Tensor self) -> Tensor", tags_8);
  m.def("gather.out(Tensor self, int dim, Tensor index, *, bool sparse_grad=False, Tensor(a!) out) -> Tensor(a!)", tags_0);
  m.def("gather(Tensor self, int dim, Tensor index, *, bool sparse_grad=False) -> Tensor", tags_6);
  ...
  m.def("sign(Tensor self) -> Tensor", tags_5);
  ...
  m.def("atan2.out(Tensor self, Tensor other, *, Tensor(a!) out) -> Tensor(a!)", tags_5);
  m.def("atan2_(Tensor(a!) self, Tensor other) -> Tensor(a!)", tags_4);
  m.def("atan2(Tensor self, Tensor other) -> Tensor", tags_5);
  ...
  m.def("fmod.Scalar(Tensor self, Scalar other) -> Tensor", tags_5);
  ...
  m.def("fmod.Tensor(Tensor self, Tensor other) -> Tensor", tags_5);
  ...
  m.def("remainder.Scalar(Tensor self, Scalar other) -> Tensor", tags_5);
  ...
  m.def("remainder.Tensor(Tensor self, Tensor other) -> Tensor", tags_5);
  ...
  m.def("maximum(Tensor self, Tensor other) -> Tensor", tags_5);
  ...
  m.def("minimum(Tensor self, Tensor other) -> Tensor", tags_5);
  ...
  m.def("sort(Tensor self, int dim=-1, bool descending=False) -> (Tensor values, Tensor indices)", tags_6);
  ...
  m.def("topk(Tensor self, SymInt k, int dim=-1, bool largest=True, bool sorted=True) -> (Tensor values, Tensor indices)", tags_6);
  m.def("all(Tensor self) -> Tensor", tags_0);
  m.def("all.all_out(Tensor self, *, Tensor(a!) out) -> Tensor(a!)", tags_0);
  m.def("any(Tensor self) -> Tensor", tags_6);
  ...
  const std::vector<at::Tag> tags_14 = {at::Tag::data_dependent_output, at::Tag::pointwise, at::Tag::pt2_compliant_tag};
  m.def("equal(Tensor self, Tensor other) -> bool", tags_14);
  m.def("pow.Tensor_Tensor_out(Tensor self, Tensor exponent, *, Tensor(a!) out) -> Tensor(a!)", tags_4);
  m.def("pow.Tensor_Tensor(Tensor self, Tensor exponent) -> Tensor", tags_5);
  m.def("pow.Scalar_out(Scalar self, Tensor exponent, *, Tensor(a!) out) -> Tensor(a!)", tags_4);
  m.def("pow.Scalar(Scalar self, Tensor exponent) -> Tensor", tags_5);
  m.def("pow.Tensor_Scalar_out(Tensor self, Scalar exponent, *, Tensor(a!) out) -> Tensor(a!)", tags_4);
  m.def("pow.Tensor_Scalar(Tensor self, Scalar exponent) -> Tensor", tags_5);
  ...
  m.def("alias(Tensor(a) self) -> Tensor(a)", tags_6);
  ...
  m.def("_foreach_norm.Scalar(Tensor[] self, Scalar ord=2) -> Tensor[]", tags_0);
  ...
  m.def("elu(Tensor self, Scalar alpha=1, Scalar scale=1, Scalar input_scale=1) -> Tensor", tags_0);
  ...
  m.def("hardsigmoid(Tensor self) -> Tensor", tags_0);
  ...
  m.def("leaky_relu(Tensor self, Scalar negative_slope=0.01) -> Tensor", tags_6);
  ...
  m.def("rrelu_with_noise.out(Tensor self, Tensor noise, Scalar lower=0.125, Scalar upper=0.3333333333333333, bool training=False, Generator? generator=None, *, Tensor(a!) out) -> Tensor(a!)", tags_2);
  m.def("rrelu_with_noise(Tensor self, Tensor noise, Scalar lower=0.125, Scalar upper=0.3333333333333333, bool training=False, Generator? generator=None) -> Tensor", tags_2);
  ...
  m.def("rrelu_with_noise_(Tensor(a!) self, Tensor noise, Scalar lower=0.125, Scalar upper=0.3333333333333333, bool training=False, Generator? generator=None) -> Tensor(a!)", tags_2);
  m.def("softplus.out(Tensor self, Scalar beta=1, Scalar threshold=20, *, Tensor(a!) out) -> Tensor(a!)", tags_0);
  m.def("softplus(Tensor self, Scalar beta=1, Scalar threshold=20) -> Tensor", tags_0);
  ...
  m.def("softshrink(Tensor self, Scalar lambd=0.5) -> Tensor", tags_0);
  ...
  m.def("_adaptive_avg_pool2d(Tensor self, SymInt[2] output_size) -> Tensor", tags_6);
  m.def("_adaptive_avg_pool2d_backward(Tensor grad_output, Tensor self) -> Tensor", tags_6);
  ...
  m.def("_adaptive_avg_pool3d(Tensor self, SymInt[3] output_size) -> Tensor", tags_6);
  ...
  m.def("avg_pool2d(Tensor self, int[2] kernel_size, int[2] stride=[], int[2] padding=0, bool ceil_mode=False, bool count_include_pad=True, int? divisor_override=None) -> Tensor", tags_6);
  ...
  m.def("avg_pool2d_backward(Tensor grad_output, Tensor self, int[2] kernel_size, int[2] stride, int[2] padding, bool ceil_mode, bool count_include_pad, int? divisor_override) -> Tensor", tags_6);
  ...
  m.def("avg_pool3d(Tensor self, int[3] kernel_size, int[3] stride=[], int[3] padding=0, bool ceil_mode=False, bool count_include_pad=True, int? divisor_override=None) -> Tensor", tags_6);
  ...
  m.def("max_pool2d_with_indices(Tensor self, int[2] kernel_size, int[2] stride=[], int[2] padding=0, int[2] dilation=1, bool ceil_mode=False) -> (Tensor, Tensor)", tags_6);
  ...
  m.def("max_pool2d_with_indices_backward(Tensor grad_output, Tensor self, int[2] kernel_size, int[2] stride, int[2] padding, int[2] dilation, bool ceil_mode, Tensor indices) -> Tensor", tags_6);
  ...
  m.def("max_pool3d_with_indices(Tensor self, int[3] kernel_size, int[3] stride=[], int[3] padding=0, int[3] dilation=1, bool ceil_mode=False) -> (Tensor, Tensor)", tags_6);
  ...
  m.def("reflection_pad1d(Tensor self, SymInt[2] padding) -> Tensor", tags_6);
  ...
  m.def("reflection_pad2d(Tensor self, SymInt[4] padding) -> Tensor", tags_6);
  ...
  m.def("reflection_pad3d(Tensor self, SymInt[6] padding) -> Tensor", tags_6);
  ...
  m.def("replication_pad2d(Tensor self, SymInt[4] padding) -> Tensor", tags_6);
  ...
  m.def("replication_pad3d(Tensor self, SymInt[6] padding) -> Tensor", tags_6);
  ...
  m.def("upsample_bilinear2d.vec(Tensor input, SymInt[]? output_size, bool align_corners, float[]? scale_factors) -> Tensor", tags_6);
  ...
  m.def("upsample_nearest2d.vec(Tensor input, SymInt[]? output_size, float[]? scale_factors) -> Tensor", tags_6);
  ...
  m.def("col2im(Tensor self, SymInt[2] output_size, int[2] kernel_size, int[2] dilation, int[2] padding, int[2] stride) -> Tensor", tags_6);
  ...
  m.def("isfinite(Tensor self) -> Tensor", tags_0);
  ...
  m.def("_remove_batch_dim(Tensor self, int level, int batch_size, int out_dim) -> Tensor", tags_0);
  ...
  m.def("linalg_lstsq(Tensor self, Tensor b, float? rcond=None, *, str? driver=None) -> (Tensor solution, Tensor residuals, Tensor rank, Tensor singular_values)", tags_8);
  m.def("linalg_lstsq.out(Tensor self, Tensor b, float? rcond=None, *, str? driver=None, Tensor(a!) solution, Tensor(b!) residuals, Tensor(c!) rank, Tensor(d!) singular_values) -> (Tensor(a!) solution, Tensor(b!) residuals, Tensor(c!) rank, Tensor(d!) singular_values)", tags_8);
  ...
  m.def("_test_autograd_multiple_dispatch_view_copy(Tensor self) -> Tensor", tags_11);
  ...
  m.def("pad_sequence(Tensor[] sequences, bool batch_first=False, float padding_value=0.0) -> Tensor", tags_0);
  ...
  m.def("_fw_primal_copy(Tensor self, int level) -> Tensor", tags_11);
  m.def("_make_dual_copy(Tensor primal, Tensor tangent, int level) -> Tensor", tags_11);
  m.def("view_as_real_copy(Tensor self) -> Tensor", tags_11);
  m.def("view_as_complex_copy(Tensor self) -> Tensor", tags_11);
  m.def("_conj_copy(Tensor self) -> Tensor", tags_11);
  m.def("_neg_view_copy(Tensor self) -> Tensor", tags_11);
  m.def("as_strided_copy(Tensor self, SymInt[] size, SymInt[] stride, SymInt? storage_offset=None) -> Tensor", tags_11);
  m.def("_sparse_broadcast_to_copy(Tensor self, int[] size) -> Tensor", tags_11);
  m.def("diagonal_copy(Tensor self, int offset=0, int dim1=0, int dim2=1) -> Tensor", tags_11);
  m.def("expand_copy(Tensor self, SymInt[] size, *, bool implicit=False) -> Tensor", tags_11);
  m.def("permute_copy(Tensor self, int[] dims) -> Tensor", tags_11);
  m.def("_reshape_alias_copy(Tensor self, SymInt[] size, SymInt[] stride) -> Tensor", tags_11);
  m.def("select_copy.int(Tensor self, int dim, SymInt index) -> Tensor", tags_11);
  m.def("detach_copy(Tensor self) -> Tensor", tags_11);
  m.def("slice_copy.Tensor(Tensor self, int dim=0, SymInt? start=None, SymInt? end=None, SymInt step=1) -> Tensor", tags_11);
  m.def("split_copy.Tensor(Tensor self, SymInt split_size, int dim=0) -> Tensor[]", tags_11);
  m.def("split_with_sizes_copy(Tensor self, SymInt[] split_sizes, int dim=0) -> Tensor[]", tags_11);
  m.def("squeeze_copy(Tensor self) -> Tensor", tags_11);
  m.def("squeeze_copy.dim(Tensor self, int dim) -> Tensor", tags_11);
  m.def("squeeze_copy.dims(Tensor self, int[] dim) -> Tensor", tags_11);
  m.def("t_copy(Tensor self) -> Tensor", tags_11);
  m.def("transpose_copy.int(Tensor self, int dim0, int dim1) -> Tensor", tags_11);
  m.def("unsqueeze_copy(Tensor self, int dim) -> Tensor", tags_11);
  m.def("_indices_copy(Tensor self) -> Tensor", tags_11);
  m.def("_values_copy(Tensor self) -> Tensor", tags_11);
  m.def("indices_copy(Tensor self) -> Tensor", tags_11);
  m.def("values_copy(Tensor self) -> Tensor", tags_11);
  m.def("crow_indices_copy(Tensor self) -> Tensor", tags_11);
  m.def("col_indices_copy(Tensor self) -> Tensor", tags_11);
  m.def("ccol_indices_copy(Tensor self) -> Tensor", tags_11);
  m.def("row_indices_copy(Tensor self) -> Tensor", tags_11);
  m.def("unbind_copy.int(Tensor self, int dim=0) -> Tensor[]", tags_11);
  ...
  m.def("view_copy(Tensor self, SymInt[] size) -> Tensor", tags_11);
  m.def("view_copy.dtype(Tensor self, ScalarType dtype) -> Tensor", tags_11);
  m.def("unfold_copy(Tensor self, int dimension, int size, int step) -> Tensor", tags_11);
  m.def("alias_copy(Tensor self) -> Tensor", tags_11);
  ...
  m.def("scaled_dot_product_attention(Tensor query, Tensor key, Tensor value, Tensor? attn_mask=None, float dropout_p=0.0, bool is_causal=False, *, float? scale=None) -> Tensor", tags_2);
  m.def("_fused_sdp_choice(Tensor query, Tensor key, Tensor value, Tensor? attn_mask=None, float dropout_p=0.0, bool is_causal=False, *, float? scale=None) -> int", tags_2);
  m.def("_scaled_dot_product_attention_math(Tensor query, Tensor key, Tensor value, Tensor? attn_mask=None, float dropout_p=0.0, bool is_causal=False, Tensor? dropout_mask=None, *, float? scale=None) -> (Tensor, Tensor)", tags_2);
  ...
  m.def("_flash_attention_forward(Tensor query, Tensor key, Tensor value, Tensor? cum_seq_q, Tensor? cum_seq_k, SymInt max_q, SymInt max_k, float dropout_p, bool is_causal, bool return_debug_mask, *, float? scale=None) -> (Tensor output, Tensor softmax_logsumexp, Tensor philox_seed, Tensor philox_offset, Tensor debug_attn_mask)", tags_2);
  m.def("_flash_attention_backward(Tensor grad_out, Tensor query, Tensor key, Tensor value, Tensor out, Tensor logsumexp, Tensor cum_seq_q, Tensor cum_seq_k, SymInt max_q, SymInt max_k, float dropout_p, bool is_causal, Tensor philox_seed, Tensor philox_offset, *, float? scale=None) -> (Tensor, Tensor, Tensor)", tags_0);
  m.def("_efficient_attention_forward(Tensor query, Tensor key, Tensor value, Tensor? bias, Tensor? cu_seqlens_q, Tensor? cu_seqlens_k, int? max_seqlen_q, int? max_seqlen_k, float dropout_p, int custom_mask_type, bool compute_log_sumexp=False, *, float? scale=None, Tensor? causal_diagonal=None, Tensor? seqlen_k=None) -> (Tensor output, Tensor logsumexp, Tensor philox_seed, Tensor philox_offset, SymInt max_seqlen_batch_q, SymInt max_seqlen_batch_k)", tags_2);
  m.def("_efficient_attention_backward(Tensor grad_out_, Tensor query, Tensor key, Tensor value, Tensor? bias, Tensor out, Tensor? cu_seqlens_q, Tensor? cu_seqlens_k, SymInt max_seqlen_q, SymInt max_seqlen_k, Tensor logsumexp, float dropout_p, Tensor philox_seed, Tensor philox_offset, int custom_mask_type, bool bias_requires_grad, *, float? scale=None, int? num_splits_key=None) -> (Tensor, Tensor, Tensor, Tensor)", tags_0);
  ...
  const std::vector<at::Tag> tags_15 = {at::Tag::generated, at::Tag::pt2_compliant_tag};
  m.def("_new_zeros_with_same_feature_meta.out(Tensor self, Tensor other, *, int self_num_batch_dims=0, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("_cudnn_ctc_loss.out(Tensor log_probs, Tensor targets, int[] input_lengths, int[] target_lengths, int blank, bool deterministic, bool zero_infinity, *, Tensor(a!) out0, Tensor(b!) out1) -> (Tensor(a!), Tensor(b!))", tags_15);
  m.def("_cudnn_rnn_flatten_weight.out(Tensor[] weight_arr, int weight_stride0, SymInt input_size, int mode, SymInt hidden_size, SymInt proj_size, int num_layers, bool batch_first, bool bidirectional, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  const std::vector<at::Tag> tags_16 = {at::Tag::generated, at::Tag::nondeterministic_seeded, at::Tag::pt2_compliant_tag};
  m.def("_cudnn_rnn.out(Tensor input, Tensor[] weight, int weight_stride0, Tensor? weight_buf, Tensor hx, Tensor? cx, int mode, SymInt hidden_size, SymInt proj_size, int num_layers, bool batch_first, float dropout, bool train, bool bidirectional, SymInt[] batch_sizes, Tensor? dropout_state, *, Tensor(a!) out0, Tensor(b!) out1, Tensor(c!) out2, Tensor(d!) out3, Tensor(e!) out4) -> (Tensor(a!), Tensor(b!), Tensor(c!), Tensor(d!), Tensor(e!))", tags_16);
  m.def("_cudnn_rnn_backward.out(Tensor input, Tensor[] weight, int weight_stride0, Tensor weight_buf, Tensor hx, Tensor? cx, Tensor output, Tensor? grad_output, Tensor? grad_hy, Tensor? grad_cy, int mode, SymInt hidden_size, SymInt proj_size, int num_layers, bool batch_first, float dropout, bool train, bool bidirectional, SymInt[] batch_sizes, Tensor? dropout_state, Tensor reserve, bool[4] output_mask, *, Tensor(a!) out0, Tensor(b!) out1, Tensor(c!) out2, Tensor(d!)[] out3) -> ()", tags_15);
  m.def("_cudnn_init_dropout_state.out(float dropout, bool train, int dropout_seed, *, Tensor(a!) out) -> Tensor(a!)", tags_16);
  m.def("_fused_dropout.out(Tensor self, float p, Generator? generator=None, *, Tensor(a!) out0, Tensor(b!) out1) -> (Tensor(a!), Tensor(b!))", tags_16);
  m.def("_masked_scale.out(Tensor self, Tensor mask, float scale, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("native_dropout.out(Tensor input, float p, bool? train, *, Tensor(a!) out0, Tensor(b!) out1) -> (Tensor(a!), Tensor(b!))", tags_16);
  m.def("native_dropout_backward.out(Tensor grad_output, Tensor mask, float scale, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("_conj_physical.out(Tensor self, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("_add_relu.Scalar_out(Tensor self, Scalar other, Scalar alpha=1, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("add.Scalar_out(Tensor self, Scalar other, Scalar alpha=1, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("affine_grid_generator.out(Tensor theta, SymInt[] size, bool align_corners, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("_test_functorch_fallback.out(Tensor self, Tensor other, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("bartlett_window.out(int window_length, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("bartlett_window.periodic_out(int window_length, bool periodic, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("quantized_batch_norm.out(Tensor input, Tensor? weight, Tensor? bias, Tensor mean, Tensor var, float eps, float output_scale, int output_zero_point, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("bernoulli.Tensor_out(Tensor self, Tensor p, *, Generator? generator=None, Tensor(a!) out) -> Tensor(a!)", tags_16);
  m.def("bernoulli.Tensor(Tensor self, Tensor p, *, Generator? generator=None) -> Tensor", tags_16);
  m.def("bernoulli.float_out(Tensor self, float p=0.5, *, Generator? generator=None, Tensor(a!) out) -> Tensor(a!)", tags_16);
  m.def("binary_cross_entropy_with_logits.out(Tensor self, Tensor target, Tensor? weight=None, Tensor? pos_weight=None, int reduction=Mean, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("bincount.out(Tensor self, Tensor? weights=None, int minlength=0, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("blackman_window.out(int window_length, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("blackman_window.periodic_out(int window_length, bool periodic, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("block_diag.out(Tensor[] tensors, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("constant_pad_nd.out(Tensor self, SymInt[] pad, Scalar value=0, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("convolution.out(Tensor input, Tensor weight, Tensor? bias, SymInt[] stride, SymInt[] padding, SymInt[] dilation, bool transposed, SymInt[] output_padding, SymInt groups, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("convolution_backward.out(Tensor grad_output, Tensor input, Tensor weight, SymInt[]? bias_sizes, SymInt[] stride, SymInt[] padding, SymInt[] dilation, bool transposed, SymInt[] output_padding, SymInt groups, bool[3] output_mask, *, Tensor(a!) out0, Tensor(b!) out1, Tensor(c!) out2) -> (Tensor(a!), Tensor(b!), Tensor(c!))", tags_15);
  m.def("convolution_overrideable.out(Tensor input, Tensor weight, Tensor? bias, SymInt[] stride, SymInt[] padding, SymInt[] dilation, bool transposed, SymInt[] output_padding, SymInt groups, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("convolution_backward_overrideable.out(Tensor grad_output, Tensor input, Tensor weight, SymInt[] stride, SymInt[] padding, SymInt[] dilation, bool transposed, SymInt[] output_padding, SymInt groups, bool[3] output_mask, *, Tensor(a!) out0, Tensor(b!) out1, Tensor(c!) out2) -> (Tensor(a!), Tensor(b!), Tensor(c!))", tags_15);
  m.def("_convolution.out(Tensor input, Tensor weight, Tensor? bias, SymInt[] stride, SymInt[] padding, SymInt[] dilation, bool transposed, SymInt[] output_padding, SymInt groups, bool benchmark, bool deterministic, bool cudnn_enabled, bool allow_tf32, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("conv_tbc.out(Tensor self, Tensor weight, Tensor bias, int pad=0, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("copy.out(Tensor self, Tensor src, bool non_blocking=False, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("_copy_from.out(Tensor self, Tensor dst, bool non_blocking=False, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("_copy_from_and_resize.out(Tensor self, Tensor dst, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("count_nonzero.dim_IntList_out(Tensor self, int[] dim, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("count_nonzero.out(Tensor self, int? dim=None, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("cudnn_affine_grid_generator.out(Tensor theta, int N, int C, int H, int W, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("cudnn_affine_grid_generator_backward.out(Tensor grad, int N, int C, int H, int W, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("cudnn_batch_norm.out(Tensor input, Tensor weight, Tensor? bias, Tensor? running_mean, Tensor? running_var, bool training, float exponential_average_factor, float epsilon, *, Tensor(a!) out0, Tensor(b!) out1, Tensor(c!) out2, Tensor(d!) out3) -> (Tensor(a!), Tensor(b!), Tensor(c!), Tensor(d!))", tags_15);
  m.def("cudnn_batch_norm_backward.out(Tensor input, Tensor grad_output, Tensor weight, Tensor? running_mean, Tensor? running_var, Tensor? save_mean, Tensor? save_var, float epsilon, Tensor reserveSpace, *, Tensor(a!) out0, Tensor(b!) out1, Tensor(c!) out2) -> (Tensor(a!), Tensor(b!), Tensor(c!))", tags_15);
  m.def("cudnn_convolution_transpose.out(Tensor self, Tensor weight, SymInt[] padding, SymInt[] output_padding, SymInt[] stride, SymInt[] dilation, SymInt groups, bool benchmark, bool deterministic, bool allow_tf32, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("_mps_convolution_transpose.out(Tensor self, Tensor weight, SymInt[] padding, SymInt[] output_padding, SymInt[] stride, SymInt[] dilation, SymInt groups, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("mps_convolution_transpose_backward.out(Tensor self, Tensor grad_output, Tensor weight, SymInt[] padding, SymInt[] output_padding, SymInt[] stride, SymInt[] dilation, SymInt groups, bool[2] output_mask, *, Tensor(a!) out0, Tensor(b!) out1) -> (Tensor(a!), Tensor(b!))", tags_15);
  m.def("cudnn_convolution_relu.out(Tensor self, Tensor weight, Tensor? bias, SymInt[] stride, SymInt[] padding, SymInt[] dilation, SymInt groups, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("cudnn_convolution_add_relu.out(Tensor self, Tensor weight, Tensor z, Scalar? alpha, Tensor? bias, SymInt[] stride, SymInt[] padding, SymInt[] dilation, SymInt groups, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("cudnn_grid_sampler.out(Tensor self, Tensor grid, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("cudnn_grid_sampler_backward.out(Tensor self, Tensor grid, Tensor grad_output, *, Tensor(a!) out0, Tensor(b!) out1) -> (Tensor(a!), Tensor(b!))", tags_15);
  m.def("_ctc_loss.out(Tensor log_probs, Tensor targets, int[] input_lengths, int[] target_lengths, int blank=0, bool zero_infinity=False, *, Tensor(a!) out0, Tensor(b!) out1) -> (Tensor(a!), Tensor(b!))", tags_15);
  m.def("_ctc_loss.Tensor_out(Tensor log_probs, Tensor targets, Tensor input_lengths, Tensor target_lengths, int blank=0, bool zero_infinity=False, *, Tensor(a!) out0, Tensor(b!) out1) -> (Tensor(a!), Tensor(b!))", tags_15);
  m.def("_ctc_loss_backward.out(Tensor grad, Tensor log_probs, Tensor targets, int[] input_lengths, int[] target_lengths, Tensor neg_log_likelihood, Tensor log_alpha, int blank, bool zero_infinity=False, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("diag_embed.out(Tensor self, int offset=0, int dim1=-2, int dim2=-1, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("diagonal_backward.out(Tensor grad_output, SymInt[] input_sizes, int offset, int dim1, int dim2, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("div.Scalar_out(Tensor self, Scalar other, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("div.Scalar_mode_out(Tensor self, Scalar other, *, str? rounding_mode, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("embedding.out(Tensor weight, Tensor indices, SymInt padding_idx=-1, bool scale_grad_by_freq=False, bool sparse=False, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("embedding_dense_backward.out(Tensor grad_output, Tensor indices, SymInt num_weights, SymInt padding_idx, bool scale_grad_by_freq, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("embedding_renorm.out(Tensor self, Tensor indices, float max_norm, float norm_type, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("embedding_renorm(Tensor self, Tensor indices, float max_norm, float norm_type) -> Tensor", tags_15);
  m.def("_embedding_bag_forward_only.out(Tensor weight, Tensor indices, Tensor offsets, bool scale_grad_by_freq=False, int mode=0, bool sparse=False, Tensor? per_sample_weights=None, bool include_last_offset=False, int padding_idx=-1, *, Tensor(a!) out0, Tensor(b!) out1, Tensor(c!) out2, Tensor(d!) out3) -> (Tensor(a!), Tensor(b!), Tensor(c!), Tensor(d!))", tags_15);
  m.def("_embedding_bag.out(Tensor weight, Tensor indices, Tensor offsets, bool scale_grad_by_freq=False, int mode=0, bool sparse=False, Tensor? per_sample_weights=None, bool include_last_offset=False, int padding_idx=-1, *, Tensor(a!) out0, Tensor(b!) out1, Tensor(c!) out2, Tensor(d!) out3) -> (Tensor(a!), Tensor(b!), Tensor(c!), Tensor(d!))", tags_15);
  m.def("_embedding_bag_dense_backward.out(Tensor grad, Tensor indices, Tensor offset2bag, Tensor bag_size, Tensor maximum_indices, SymInt num_weights, bool scale_grad_by_freq, int mode, Tensor? per_sample_weights, int padding_idx=-1, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("_embedding_bag_per_sample_weights_backward.out(Tensor grad, Tensor weight, Tensor indices, Tensor offsets, Tensor offset2bag, int mode, int padding_idx=-1, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("empty.names_out(int[] size, *, Dimname[]? names, MemoryFormat? memory_format=None, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("empty_permuted.out(SymInt[] size, int[] physical_layout, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("new_empty.out(Tensor self, SymInt[] size, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("new_empty_strided.out(Tensor self, SymInt[] size, SymInt[] stride, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("new_full.out(Tensor self, SymInt[] size, Scalar fill_value, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("new_zeros.out(Tensor self, SymInt[] size, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("new_ones.out(Tensor self, SymInt[] size, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("_empty_affine_quantized.out(SymInt[] size, *, float scale=1, int zero_point=0, MemoryFormat? memory_format=contiguous_format, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("_empty_per_channel_affine_quantized.out(SymInt[] size, *, Tensor scales, Tensor zero_points, int axis, MemoryFormat? memory_format=contiguous_format, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("resize.out(Tensor self, SymInt[] size, *, MemoryFormat? memory_format=None, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("resize(Tensor self, SymInt[] size, *, MemoryFormat? memory_format=None) -> Tensor", tags_15);
  m.def("_resize_output.out(Tensor self, SymInt[] size, Device device, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("_resize_output(Tensor self, SymInt[] size, Device device) -> Tensor", tags_15);
  m.def("empty_quantized.out(int[] size, Tensor qtensor, *, MemoryFormat? memory_format=None, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("empty_like.out(Tensor self, *, MemoryFormat? memory_format=None, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("empty_strided.out(SymInt[] size, SymInt[] stride, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("fill.Scalar_out(Tensor self, Scalar value, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("fill.Tensor_out(Tensor self, Tensor value, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("floor_divide.Scalar_out(Tensor self, Scalar other, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("full.names_out(int[] size, Scalar fill_value, *, Dimname[]? names, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("full_like.out(Tensor self, Scalar fill_value, *, MemoryFormat? memory_format=None, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("from_file.out(str filename, bool? shared=None, int? size=0, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("grid_sampler_2d.out(Tensor input, Tensor grid, int interpolation_mode, int padding_mode, bool align_corners, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("grid_sampler_2d_backward.out(Tensor grad_output, Tensor input, Tensor grid, int interpolation_mode, int padding_mode, bool align_corners, bool[2] output_mask, *, Tensor(a!) out0, Tensor(b!) out1) -> (Tensor(a!), Tensor(b!))", tags_15);
  m.def("_grid_sampler_2d_cpu_fallback.out(Tensor input, Tensor grid, int interpolation_mode, int padding_mode, bool align_corners, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("grid_sampler_3d.out(Tensor input, Tensor grid, int interpolation_mode, int padding_mode, bool align_corners, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("grid_sampler_3d_backward.out(Tensor grad_output, Tensor input, Tensor grid, int interpolation_mode, int padding_mode, bool align_corners, bool[2] output_mask, *, Tensor(a!) out0, Tensor(b!) out1) -> (Tensor(a!), Tensor(b!))", tags_15);
  m.def("hann_window.out(int window_length, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("hann_window.periodic_out(int window_length, bool periodic, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("hamming_window.out(int window_length, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("hamming_window.periodic_out(int window_length, bool periodic, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("hamming_window.periodic_alpha_out(int window_length, bool periodic, float alpha, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("hamming_window.periodic_alpha_beta_out(int window_length, bool periodic, float alpha, float beta, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("kaiser_window.out(int window_length, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("kaiser_window.periodic_out(int window_length, bool periodic, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("kaiser_window.beta_out(int window_length, bool periodic, float beta, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("native_group_norm.out(Tensor input, Tensor? weight, Tensor? bias, SymInt N, SymInt C, SymInt HxW, int group, float eps, *, Tensor(a!) out0, Tensor(b!) out1, Tensor(c!) out2) -> (Tensor(a!), Tensor(b!), Tensor(c!))", tags_15);
  m.def("native_group_norm_backward.out(Tensor grad_out, Tensor input, Tensor mean, Tensor rstd, Tensor? weight, SymInt N, SymInt C, SymInt HxW, int group, bool[3] output_mask, *, Tensor(a!) out0, Tensor(b!) out1, Tensor(c!) out2) -> (Tensor(a!), Tensor(b!), Tensor(c!))", tags_15);
  m.def("index_put.out(Tensor self, Tensor?[] indices, Tensor values, bool accumulate=False, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("_index_put_impl.out(Tensor self, Tensor?[] indices, Tensor values, bool accumulate=False, bool unsafe=False, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("_index_put_impl(Tensor self, Tensor?[] indices, Tensor values, bool accumulate=False, bool unsafe=False) -> Tensor", tags_15);
  m.def("isnan.out(Tensor self, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("native_layer_norm.out(Tensor input, SymInt[] normalized_shape, Tensor? weight, Tensor? bias, float eps, *, Tensor(a!) out0, Tensor(b!) out1, Tensor(c!) out2) -> (Tensor(a!), Tensor(b!), Tensor(c!))", tags_15);
  m.def("native_layer_norm_backward.out(Tensor grad_out, Tensor input, SymInt[] normalized_shape, Tensor mean, Tensor rstd, Tensor? weight, Tensor? bias, bool[3] output_mask, *, Tensor(a!) out0, Tensor(b!) out1, Tensor(c!) out2) -> (Tensor(a!), Tensor(b!), Tensor(c!))", tags_15);
  m.def("linear_backward.out(Tensor self, Tensor grad_output, Tensor weight, bool[3] output_mask, *, Tensor(a!) out0, Tensor(b!) out1, Tensor(c!) out2) -> (Tensor(a!), Tensor(b!), Tensor(c!))", tags_15);
  m.def("mkldnn_linear.out(Tensor self, Tensor weight, Tensor? bias=None, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("mkldnn_linear_backward_input.out(int[] input_size, Tensor grad_output, Tensor weight, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("mkldnn_linear_backward_weights.out(Tensor grad_output, Tensor input, Tensor weight, bool bias_defined, *, Tensor(a!) out0, Tensor(b!) out1) -> (Tensor(a!), Tensor(b!))", tags_15);
  m.def("mkldnn_linear_backward.out(Tensor self, Tensor grad_output, Tensor weight, bool[3] output_mask, *, Tensor(a!) out0, Tensor(b!) out1, Tensor(c!) out2) -> (Tensor(a!), Tensor(b!), Tensor(c!))", tags_15);
  m.def("matmul_backward.out(Tensor grad, Tensor self, Tensor other, bool[2] mask, *, Tensor(a!) out0, Tensor(b!) out1) -> (Tensor(a!), Tensor(b!))", tags_15);
  m.def("_aminmax.out(Tensor self, *, Tensor(a!) out0, Tensor(b!) out1) -> (Tensor(a!), Tensor(b!))", tags_15);
  m.def("_aminmax.dim_out(Tensor self, int dim, bool keepdim=False, *, Tensor(a!) out0, Tensor(b!) out1) -> (Tensor(a!), Tensor(b!))", tags_15);
  m.def("max_pool2d_backward.out(Tensor grad_output, Tensor self, int[2] kernel_size, int[2] stride=[], int[2] padding=0, int[2] dilation=1, bool ceil_mode=False, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("mkldnn_max_pool2d.out(Tensor self, int[2] kernel_size, int[2] stride=[], int[2] padding=0, int[2] dilation=1, bool ceil_mode=False, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("mkldnn_max_pool2d_backward.out(Tensor grad_output, Tensor output, Tensor input, int[2] kernel_size, int[2] stride=[], int[2] padding=0, int[2] dilation=1, bool ceil_mode=False, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("mkldnn_max_pool3d.out(Tensor self, int[3] kernel_size, int[3] stride=[], int[3] padding=0, int[3] dilation=1, bool ceil_mode=False, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("mkldnn_max_pool3d_backward.out(Tensor grad_output, Tensor output, Tensor input, int[3] kernel_size, int[3] stride=[], int[3] padding=0, int[3] dilation=1, bool ceil_mode=False, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("quantized_max_pool1d.out(Tensor self, int[1] kernel_size, int[1] stride=[], int[1] padding=0, int[1] dilation=1, bool ceil_mode=False, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("quantized_max_pool2d.out(Tensor self, int[2] kernel_size, int[2] stride=[], int[2] padding=0, int[2] dilation=1, bool ceil_mode=False, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("quantized_max_pool3d.out(Tensor self, int[3] kernel_size, int[3] stride=[], int[3] padding=0, int[3] dilation=1, bool ceil_mode=False, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("median.out(Tensor self, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("nanmedian.out(Tensor self, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("_mps_convolution.out(Tensor self, Tensor weight, Tensor? bias, SymInt[] padding, SymInt[] stride, SymInt[] dilation, SymInt groups, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("mps_convolution_backward.out(Tensor self, Tensor grad_output, Tensor weight, SymInt[] padding, SymInt[] stride, SymInt[] dilation, SymInt groups, bool[3] output_mask, *, Tensor(a!) out0, Tensor(b!) out1, Tensor(c!) out2) -> (Tensor(a!), Tensor(b!), Tensor(c!))", tags_15);
  m.def("mkldnn_convolution.out(Tensor self, Tensor weight, Tensor? bias, SymInt[] padding, SymInt[] stride, SymInt[] dilation, SymInt groups, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  ...
  m.def("mkldnn_rnn_layer_backward.out(Tensor input, Tensor weight1, Tensor weight2, Tensor weight3, Tensor weight4, Tensor hx_, Tensor cx_tmp, Tensor output, Tensor hy_, Tensor cy_, Tensor? grad_output, Tensor? grad_hy, Tensor? grad_cy, bool reverse, int mode, int hidden_size, int num_layers, bool has_biases, bool train, bool bidirectional, int[] batch_sizes, bool batch_first, Tensor workspace, *, Tensor(a!) out0, Tensor(b!) out1, Tensor(c!) out2, Tensor(d!) out3, Tensor(e!) out4, Tensor(f!) out5, Tensor(g!) out6) -> (Tensor(a!), Tensor(b!), Tensor(c!), Tensor(d!), Tensor(e!), Tensor(f!), Tensor(g!))", tags_15);
  m.def("miopen_batch_norm.out(Tensor input, Tensor weight, Tensor? bias, Tensor? running_mean, Tensor? running_var, bool training, float exponential_average_factor, float epsilon, *, Tensor(a!) out0, Tensor(b!) out1, Tensor(c!) out2) -> (Tensor(a!), Tensor(b!), Tensor(c!))", tags_15);
  m.def("miopen_batch_norm_backward.out(Tensor input, Tensor grad_output, Tensor weight, Tensor? running_mean, Tensor? running_var, Tensor? save_mean, Tensor? save_var, float epsilon, *, Tensor(a!) out0, Tensor(b!) out1, Tensor(c!) out2) -> (Tensor(a!), Tensor(b!), Tensor(c!))", tags_15);
  m.def("miopen_convolution.out(Tensor self, Tensor weight, Tensor? bias, SymInt[] padding, SymInt[] stride, SymInt[] dilation, SymInt groups, bool benchmark, bool deterministic, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("miopen_convolution_transpose.out(Tensor self, Tensor weight, Tensor? bias, SymInt[] padding, SymInt[] output_padding, SymInt[] stride, SymInt[] dilation, SymInt groups, bool benchmark, bool deterministic, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("miopen_depthwise_convolution.out(Tensor self, Tensor weight, Tensor? bias, SymInt[] padding, SymInt[] stride, SymInt[] dilation, SymInt groups, bool benchmark, bool deterministic, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  ...
  m.def("miopen_rnn_backward.out(Tensor input, Tensor[] weight, int weight_stride0, Tensor weight_buf, Tensor hx, Tensor? cx, Tensor output, Tensor? grad_output, Tensor? grad_hy, Tensor? grad_cy, int mode, int hidden_size, int num_layers, bool batch_first, float dropout, bool train, bool bidirectional, int[] batch_sizes, Tensor? dropout_state, Tensor reserve, bool[4] output_mask, *, Tensor(a!) out0, Tensor(b!) out1, Tensor(c!) out2, Tensor(d!)[] out3) -> ()", tags_15);
  m.def("_sparse_sparse_matmul.out(Tensor self, Tensor other, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("mul.Scalar_out(Tensor self, Scalar other, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("_native_batch_norm_legit_functional(Tensor input, Tensor? weight, Tensor? bias, Tensor running_mean, Tensor running_var, bool training, float momentum, float eps) -> (Tensor, Tensor, Tensor, Tensor running_mean_out, Tensor running_var_out)", tags_15);
  m.def("_native_batch_norm_legit_no_training.out(Tensor input, Tensor? weight, Tensor? bias, Tensor running_mean, Tensor running_var, float momentum, float eps, *, Tensor(a!) out0, Tensor(b!) out1, Tensor(c!) out2) -> (Tensor(a!), Tensor(b!), Tensor(c!))", tags_15);
  m.def("batch_norm_stats.out(Tensor input, float eps, *, Tensor(a!) out0, Tensor(b!) out1) -> (Tensor(a!), Tensor(b!))", tags_15);
  m.def("batch_norm_gather_stats.out(Tensor input, Tensor mean, Tensor invstd, Tensor? running_mean, Tensor? running_var, float momentum, float eps, int count, *, Tensor(a!) out0, Tensor(b!) out1) -> (Tensor(a!), Tensor(b!))", tags_15);
  m.def("batch_norm_gather_stats_with_counts.out(Tensor input, Tensor mean, Tensor invstd, Tensor? running_mean, Tensor? running_var, float momentum, float eps, Tensor counts, *, Tensor(a!) out0, Tensor(b!) out1) -> (Tensor(a!), Tensor(b!))", tags_15);
  m.def("native_batch_norm_backward.out(Tensor grad_out, Tensor input, Tensor? weight, Tensor? running_mean, Tensor? running_var, Tensor? save_mean, Tensor? save_invstd, bool train, float eps, bool[3] output_mask, *, Tensor(a!) out0, Tensor(b!) out1, Tensor(c!) out2) -> (Tensor(a!), Tensor(b!), Tensor(c!))", tags_15);
  m.def("batch_norm_backward_reduce.out(Tensor grad_out, Tensor input, Tensor mean, Tensor invstd, Tensor? weight, bool input_g, bool weight_g, bool bias_g, *, Tensor(a!) out0, Tensor(b!) out1, Tensor(c!) out2, Tensor(d!) out3) -> (Tensor(a!), Tensor(b!), Tensor(c!), Tensor(d!))", tags_15);
  m.def("batch_norm_backward_elemt.out(Tensor grad_out, Tensor input, Tensor mean, Tensor invstd, Tensor? weight, Tensor sum_dy, Tensor sum_dy_xmu, Tensor count, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("batch_norm_update_stats.out(Tensor input, Tensor? running_mean, Tensor? running_var, float momentum, *, Tensor(a!) out0, Tensor(b!) out1) -> (Tensor(a!), Tensor(b!))", tags_15);
  m.def("_nnpack_spatial_convolution.out(Tensor input, Tensor weight, Tensor? bias, SymInt[2] padding, SymInt[2] stride=1, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("ones.names_out(int[] size, *, Dimname[]? names, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("ones_like.out(Tensor self, *, MemoryFormat? memory_format=None, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("_euclidean_dist.out(Tensor x1, Tensor x2, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("_cdist_forward.out(Tensor x1, Tensor x2, float p, int? compute_mode, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("_cdist_backward.out(Tensor grad, Tensor x1, Tensor x2, float p, Tensor cdist, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("_pdist_forward.out(Tensor self, float p=2, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("_pdist_backward.out(Tensor grad, Tensor self, float p, Tensor pdist, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("pixel_shuffle.out(Tensor self, int upscale_factor, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("pixel_unshuffle.out(Tensor self, int downscale_factor, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("channel_shuffle.out(Tensor self, SymInt groups, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("_pin_memory.out(Tensor self, Device? device=None, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("scalar_tensor.out(Scalar s, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("rand.names_out(SymInt[] size, *, Dimname[]? names, Tensor(a!) out) -> Tensor(a!)", tags_16);
  m.def("rand.generator_with_names_out(SymInt[] size, *, Generator? generator, Dimname[]? names, Tensor(a!) out) -> Tensor(a!)", tags_16);
  m.def("rand_like.out(Tensor self, *, MemoryFormat? memory_format=None, Tensor(a!) out) -> Tensor(a!)", tags_16);
  m.def("randint_like.out(Tensor self, SymInt high, *, MemoryFormat? memory_format=None, Tensor(a!) out) -> Tensor(a!)", tags_16);
  m.def("randint_like.low_dtype_out(Tensor self, SymInt low, SymInt high, *, MemoryFormat? memory_format=None, Tensor(a!) out) -> Tensor(a!)", tags_16);
  m.def("randn.names_out(SymInt[] size, *, Dimname[]? names, Tensor(a!) out) -> Tensor(a!)", tags_16);
  m.def("randn.generator_with_names_out(SymInt[] size, *, Generator? generator, Dimname[]? names, Tensor(a!) out) -> Tensor(a!)", tags_16);
  m.def("randn_like.out(Tensor self, *, MemoryFormat? memory_format=None, Tensor(a!) out) -> Tensor(a!)", tags_16);
  m.def("repeat.out(Tensor self, SymInt[] repeats, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("repeat_interleave.Tensor_out(Tensor repeats, *, SymInt? output_size=None, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("_mkldnn_reshape.out(Tensor self, int[] shape, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("relu.out(Tensor self, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("select_backward.out(Tensor grad_output, SymInt[] input_sizes, int dim, SymInt index, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("celu.out(Tensor self, Scalar alpha=1.0, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("slice_backward.out(Tensor grad_output, SymInt[] input_sizes, int dim, SymInt start, SymInt end, SymInt step, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  const std::vector<at::Tag> tags_17 = {at::Tag::generated, at::Tag::pt2_compliant_tag, at::Tag::view_copy};
  m.def("slice_scatter.out(Tensor self, Tensor src, int dim=0, SymInt? start=None, SymInt? end=None, SymInt step=1, *, Tensor(a!) out) -> Tensor(a!)", tags_17);
  m.def("select_scatter.out(Tensor self, Tensor src, int dim, SymInt index, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("diagonal_scatter.out(Tensor self, Tensor src, int offset=0, int dim1=0, int dim2=1, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("as_strided_scatter.out(Tensor self, Tensor src, SymInt[] size, SymInt[] stride, SymInt? storage_offset=None, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("unsafe_split.Tensor_out(Tensor self, SymInt split_size, int dim=0, *, Tensor(a!)[] out) -> ()", tags_15);
  m.def("unsafe_split_with_sizes.out(Tensor self, SymInt[] split_sizes, int dim=0, *, Tensor(a!)[] out) -> ()", tags_15);
  m.def("sum.out(Tensor self, *, ScalarType? dtype=None, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("std_mean.correction_out(Tensor self, int[1]? dim=None, *, Scalar? correction=None, bool keepdim=False, Tensor(a!) out0, Tensor(b!) out1) -> (Tensor(a!), Tensor(b!))", tags_15);
  m.def("prod.out(Tensor self, *, ScalarType? dtype=None, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("_mkldnn_transpose.out(Tensor self, int dim0, int dim1, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("flip.out(Tensor self, int[] dims, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("roll.out(Tensor self, SymInt[1] shifts, int[1] dims=[], *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("rot90.out(Tensor self, int k=1, int[] dims=[0,1], *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("_transform_bias_rescale_qkv.out(Tensor qkv, Tensor qkv_bias, int num_heads, *, Tensor(a!) out0, Tensor(b!) out1, Tensor(c!) out2) -> (Tensor(a!), Tensor(b!), Tensor(c!))", tags_15);
  m.def("_nested_tensor_from_mask.out(Tensor t, Tensor mask, bool mask_check=True, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("_nested_from_padded.out(Tensor padded, Tensor cpu_nested_shape_example, bool fuse_transform_0213=False, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("_nested_tensor_size.out(Tensor self, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("_nested_tensor_strides.out(Tensor self, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("_nested_tensor_storage_offsets.out(Tensor self, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("_nested_from_padded_and_nested_example.out(Tensor padded, Tensor nt_example, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("_nested_view_from_buffer_copy.out(Tensor self, Tensor nested_size, Tensor nested_strides, Tensor offsets, *, Tensor(a!) out) -> Tensor(a!)", tags_17);
  m.def("_trilinear.out(Tensor i1, Tensor i2, Tensor i3, int[] expand1, int[] expand2, int[] expand3, int[] sumdim, int unroll_dim=1, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("_unique.out(Tensor self, bool sorted=True, bool return_inverse=False, *, Tensor(a!) out0, Tensor(b!) out1) -> (Tensor(a!), Tensor(b!))", tags_15);
  m.def("unique_dim.out(Tensor self, int dim, bool sorted=True, bool return_inverse=False, bool return_counts=False, *, Tensor(a!) out0, Tensor(b!) out1, Tensor(c!) out2) -> (Tensor(a!), Tensor(b!), Tensor(c!))", tags_15);
  m.def("unique_consecutive.out(Tensor self, bool return_inverse=False, bool return_counts=False, int? dim=None, *, Tensor(a!) out0, Tensor(b!) out1, Tensor(c!) out2) -> (Tensor(a!), Tensor(b!), Tensor(c!))", tags_15);
  m.def("unique_dim_consecutive.out(Tensor self, int dim, bool return_inverse=False, bool return_counts=False, *, Tensor(a!) out0, Tensor(b!) out1, Tensor(c!) out2) -> (Tensor(a!), Tensor(b!), Tensor(c!))", tags_15);
  m.def("_unique2.out(Tensor self, bool sorted=True, bool return_inverse=False, bool return_counts=False, *, Tensor(a!) out0, Tensor(b!) out1, Tensor(c!) out2) -> (Tensor(a!), Tensor(b!), Tensor(c!))", tags_15);
  m.def("_unsafe_view.out(Tensor self, SymInt[] size, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("var_mean.correction_out(Tensor self, int[1]? dim=None, *, Scalar? correction=None, bool keepdim=False, Tensor(a!) out0, Tensor(b!) out1) -> (Tensor(a!), Tensor(b!))", tags_15);
  m.def("_weight_norm_interface.out(Tensor v, Tensor g, int dim=0, *, Tensor(a!) out0, Tensor(b!) out1) -> (Tensor(a!), Tensor(b!))", tags_15);
  m.def("_weight_norm_interface_backward.out(Tensor grad_w, Tensor saved_v, Tensor saved_g, Tensor saved_norms, int dim, *, Tensor(a!) out0, Tensor(b!) out1) -> (Tensor(a!), Tensor(b!))", tags_15);
  m.def("zeros.names_out(int[] size, *, Dimname[]? names, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("_efficientzerotensor.out(SymInt[] size, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("zeros_like.out(Tensor self, *, MemoryFormat? memory_format=None, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("_standard_gamma_grad.out(Tensor self, Tensor output, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("_standard_gamma.out(Tensor self, Generator? generator=None, *, Tensor(a!) out) -> Tensor(a!)", tags_16);
  m.def("_dirichlet_grad.out(Tensor x, Tensor alpha, Tensor total, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("_sample_dirichlet.out(Tensor self, Generator? generator=None, *, Tensor(a!) out) -> Tensor(a!)", tags_16);
  m.def("poisson.out(Tensor self, Generator? generator=None, *, Tensor(a!) out) -> Tensor(a!)", tags_16);
  m.def("binomial.out(Tensor count, Tensor prob, Generator? generator=None, *, Tensor(a!) out) -> Tensor(a!)", tags_16);
  m.def("native_norm.out(Tensor self, Scalar p=2, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("native_norm.ScalarOpt_dim_dtype_out(Tensor self, Scalar? p, int[1] dim, bool keepdim, ScalarType? dtype, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("_sparse_sum.dim_out(Tensor self, int[1] dim, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("_sparse_sum_backward.out(Tensor grad, Tensor self, int[] dim, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("_sparse_csr_sum.dim_dtype_out(Tensor self, int[1] dim, bool keepdim=False, *, ScalarType? dtype=None, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("_sparse_csr_prod.dim_dtype_out(Tensor self, int[1] dim, bool keepdim=False, *, ScalarType? dtype=None, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("_sparse_softmax.out(Tensor self, int dim, bool half_to_float, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("_sparse_softmax_backward_data.out(Tensor grad_output, Tensor output, int dim, Tensor self, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("_sparse_log_softmax.out(Tensor self, int dim, bool half_to_float, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("_sparse_log_softmax_backward_data.out(Tensor grad_output, Tensor output, int dim, Tensor self, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("_spdiags.out(Tensor diagonals, Tensor offsets, int[] shape, Layout? layout=None, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("norm.ScalarOpt_dtype_out(Tensor self, Scalar? p, *, ScalarType dtype, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("norm.Scalar_out(Tensor self, Scalar p=2, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("clone.out(Tensor self, *, MemoryFormat? memory_format=None, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("resize_as.out(Tensor self, Tensor the_template, *, MemoryFormat? memory_format=None, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("resize_as(Tensor self, Tensor the_template, *, MemoryFormat? memory_format=None) -> Tensor", tags_15);
  m.def("resize_as_sparse.out(Tensor self, Tensor the_template, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("resize_as_sparse(Tensor self, Tensor the_template) -> Tensor", tags_15);
  m.def("zero.out(Tensor self, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("zero(Tensor self) -> Tensor", tags_15);
  m.def("sub.Scalar_out(Tensor self, Scalar other, Scalar alpha=1, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("rsub.Tensor_out(Tensor self, Tensor other, *, Scalar alpha=1, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("rsub.Scalar_out(Tensor self, Scalar other, Scalar alpha=1, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("_sparse_addmm.out(Tensor self, Tensor mat1, Tensor mat2, *, Scalar beta=1, Scalar alpha=1, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("sparse_coo_tensor.size_out(int[] size, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("_sparse_coo_tensor_with_dims.out(int sparse_dim, int dense_dim, int[] size, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("_sparse_coo_tensor_with_dims_and_tensors.out(int sparse_dim, int dense_dim, SymInt[] size, Tensor indices, Tensor values, *, bool? is_coalesced=None, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("sparse_resize.out(Tensor self, int[] size, int sparse_dim, int dense_dim, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("sparse_resize(Tensor self, int[] size, int sparse_dim, int dense_dim) -> Tensor", tags_15);
  m.def("sparse_resize_and_clear.out(Tensor self, int[] size, int sparse_dim, int dense_dim, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("sparse_resize_and_clear(Tensor self, int[] size, int sparse_dim, int dense_dim) -> Tensor", tags_15);
  m.def("sparse_mask.out(Tensor self, Tensor mask, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("_sparse_mask_projection.out(Tensor self, Tensor mask, bool accumulate_matches=False, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("_to_dense.out(Tensor self, ScalarType? dtype=None, bool? masked_grad=None, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("_coalesce.out(Tensor self, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("_coalesced.out(Tensor self, bool coalesced, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("_coalesced(Tensor self, bool coalesced) -> Tensor", tags_15);
  m.def("copy_sparse_to_sparse.out(Tensor self, Tensor src, bool non_blocking=False, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("copy_sparse_to_sparse(Tensor self, Tensor src, bool non_blocking=False) -> Tensor", tags_15);
  m.def("_to_sparse.sparse_dim_out(Tensor self, int sparse_dim, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("_to_sparse.out(Tensor self, *, Layout? layout=None, int[2]? blocksize=None, int? dense_dim=None, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("_to_sparse_csr.out(Tensor self, int? dense_dim=None, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("_to_sparse_csc.out(Tensor self, int? dense_dim=None, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("_to_sparse_bsr.out(Tensor self, int[2] blocksize, int? dense_dim=None, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("_to_sparse_bsc.out(Tensor self, int[2] blocksize, int? dense_dim=None, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("to_mkldnn.out(Tensor self, ScalarType? dtype=None, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("mkldnn_reorder_conv2d_weight.out(Tensor self, SymInt[2] padding=0, SymInt[2] stride=1, SymInt[2] dilation=1, SymInt groups=1, SymInt[]? input_size=None, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("mkldnn_reorder_conv3d_weight.out(Tensor self, SymInt[3] padding=0, SymInt[3] stride=1, SymInt[3] dilation=1, SymInt groups=1, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("quantize_per_tensor_dynamic.out(Tensor self, ScalarType dtype, bool reduce_range, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("quantize_per_tensor.out(Tensor self, float scale, int zero_point, ScalarType dtype, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("quantize_per_tensor.tensor_qparams_out(Tensor self, Tensor scale, Tensor zero_point, ScalarType dtype, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("quantize_per_tensor.tensors_out(Tensor[] tensors, Tensor scales, Tensor zero_points, ScalarType dtype, *, Tensor(a!)[] out) -> ()", tags_15);
  m.def("quantize_per_channel.out(Tensor self, Tensor scales, Tensor zero_points, int axis, ScalarType dtype, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("dequantize.self_out(Tensor self, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("dequantize.tensors_out(Tensor[] tensors, *, Tensor(a!)[] out) -> ()", tags_15);
  m.def("q_per_channel_scales.out(Tensor self, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("q_per_channel_zero_points.out(Tensor self, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("int_repr.out(Tensor self, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("_make_per_tensor_quantized_tensor.out(Tensor self, float scale, int zero_point, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("_make_per_channel_quantized_tensor.out(Tensor self, Tensor scale, Tensor zero_point, int axis, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("fake_quantize_per_tensor_affine_cachemask.out(Tensor self, float scale, int zero_point, int quant_min, int quant_max, *, Tensor(a!) out0, Tensor(b!) out1) -> (Tensor(a!), Tensor(b!))", tags_15);
  m.def("_fake_quantize_per_tensor_affine_cachemask_tensor_qparams.out(Tensor self, Tensor scale, Tensor zero_point, Tensor fake_quant_enabled, int quant_min, int quant_max, *, Tensor(a!) out0, Tensor(b!) out1) -> (Tensor(a!), Tensor(b!))", tags_15);
  m.def("_fake_quantize_learnable_per_tensor_affine.out(Tensor self, Tensor scale, Tensor zero_point, int quant_min, int quant_max, float grad_factor=1.0, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("fake_quantize_per_channel_affine_cachemask.out(Tensor self, Tensor scale, Tensor zero_point, int axis, int quant_min, int quant_max, *, Tensor(a!) out0, Tensor(b!) out1) -> (Tensor(a!), Tensor(b!))", tags_15);
  m.def("_fake_quantize_learnable_per_channel_affine.out(Tensor self, Tensor scale, Tensor zero_point, int axis, int quant_min, int quant_max, float grad_factor=1.0, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("_fused_moving_avg_obs_fq_helper.out(Tensor self, Tensor observer_on, Tensor fake_quant_on, Tensor(a!) running_min, Tensor(b!) running_max, Tensor(c!) scale, Tensor(d!) zero_point, float averaging_const, int quant_min, int quant_max, int ch_axis, bool per_row_fake_quant=False, bool symmetric_quant=False, *, Tensor(e!) out0, Tensor(f!) out1) -> (Tensor(e!), Tensor(f!))", tags_15);
  m.def("_fused_moving_avg_obs_fq_helper_functional(Tensor self, Tensor observer_on, Tensor fake_quant_on, Tensor running_min, Tensor running_max, Tensor scale, Tensor zero_point, float averaging_const, int quant_min, int quant_max, int ch_axis, bool per_row_fake_quant=False, bool symmetric_quant=False) -> (Tensor output, Tensor mask, Tensor running_min_out, Tensor running_max_out, Tensor scale_out, Tensor zero_point_out)", tags_15);
  m.def("_to_copy.out(Tensor self, *, bool non_blocking=False, MemoryFormat? memory_format=None, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("_lstm_mps.out(Tensor input, Tensor[] hx, Tensor[] params, bool has_biases, int num_layers, float dropout, bool train, bool bidirectional, bool batch_first, *, Tensor(a!) out0, Tensor(b!) out1, Tensor(c!) out2, Tensor(d!) out3, Tensor(e!) out4, Tensor(f!) out5) -> (Tensor(a!), Tensor(b!), Tensor(c!), Tensor(d!), Tensor(e!), Tensor(f!))", tags_16);
  m.def("lstm_mps_backward.out(Tensor? grad_y, Tensor? grad_hy, Tensor? grad_cy, Tensor z_state, Tensor cell_state_fwd, Tensor input, Tensor layersOutputs, Tensor[] hx, Tensor[] params, bool has_biases, int num_layers, float dropout, bool train, bool bidirectional, bool batch_first, *, Tensor(a!) out0, Tensor(b!)[] out1, Tensor(c!)[] out2) -> ()", tags_15);
  m.def("_thnn_fused_lstm_cell.out(Tensor input_gates, Tensor hidden_gates, Tensor cx, Tensor? input_bias=None, Tensor? hidden_bias=None, *, Tensor(a!) out0, Tensor(b!) out1, Tensor(c!) out2) -> (Tensor(a!), Tensor(b!), Tensor(c!))", tags_15);
  m.def("_thnn_fused_lstm_cell_backward_impl.out(Tensor? grad_hy, Tensor? grad_cy, Tensor cx, Tensor cy, Tensor workspace, bool has_bias, *, Tensor(a!) out0, Tensor(b!) out1, Tensor(c!) out2) -> (Tensor(a!), Tensor(b!), Tensor(c!))", tags_15);
  m.def("_thnn_fused_gru_cell.out(Tensor input_gates, Tensor hidden_gates, Tensor hx, Tensor? input_bias=None, Tensor? hidden_bias=None, *, Tensor(a!) out0, Tensor(b!) out1) -> (Tensor(a!), Tensor(b!))", tags_15);
  m.def("_thnn_fused_gru_cell_backward.out(Tensor grad_hy, Tensor workspace, bool has_bias, *, Tensor(a!) out0, Tensor(b!) out1, Tensor(c!) out2, Tensor(d!) out3, Tensor(e!) out4) -> (Tensor(a!), Tensor(b!), Tensor(c!), Tensor(d!), Tensor(e!))", tags_15);
  m.def("_pack_padded_sequence.out(Tensor input, Tensor lengths, bool batch_first, *, Tensor(a!) out0, Tensor(b!) out1) -> (Tensor(a!), Tensor(b!))", tags_15);
  m.def("set.source_Storage_out(Tensor self, Storage source, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("set.source_Storage(Tensor self, Storage source) -> Tensor", tags_15);
  m.def("set.source_Storage_storage_offset_out(Tensor self, Storage source, SymInt storage_offset, SymInt[] size, SymInt[] stride=[], *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("set.source_Storage_storage_offset(Tensor self, Storage source, SymInt storage_offset, SymInt[] size, SymInt[] stride=[]) -> Tensor", tags_15);
  m.def("set.source_Tensor_out(Tensor self, Tensor source, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("set.source_Tensor(Tensor self, Tensor source) -> Tensor", tags_15);
  m.def("set.out(Tensor self, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("set(Tensor self) -> Tensor", tags_15);
  m.def("lift.out(Tensor self, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("lift_fresh_copy.out(Tensor self, *, Tensor(a!) out) -> Tensor(a!)", tags_17);
  m.def("masked_fill.Scalar_out(Tensor self, Tensor mask, Scalar value, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("masked_fill.Tensor_out(Tensor self, Tensor mask, Tensor value, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("masked_scatter.out(Tensor self, Tensor mask, Tensor source, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("_masked_softmax.out(Tensor self, Tensor mask, int? dim=None, int? mask_type=None, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("_masked_softmax_backward.out(Tensor grad_output, Tensor output, Tensor mask, int? dim=None, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("put.out(Tensor self, Tensor index, Tensor source, bool accumulate=False, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("index_fill.int_Scalar_out(Tensor self, int dim, Tensor index, Scalar value, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("index_fill.int_Tensor_out(Tensor self, int dim, Tensor index, Tensor value, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("bitwise_and.Scalar_Tensor_out(Scalar self, Tensor other, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("bitwise_or.Scalar_Tensor_out(Scalar self, Tensor other, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("bitwise_xor.Scalar_Tensor_out(Scalar self, Tensor other, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("__lshift__.Scalar_out(Tensor self, Scalar other, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("__lshift__.Tensor_out(Tensor self, Tensor other, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("bitwise_left_shift.Scalar_Tensor_out(Scalar self, Tensor other, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("__rshift__.Scalar_out(Tensor self, Scalar other, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("__rshift__.Tensor_out(Tensor self, Tensor other, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("bitwise_right_shift.Scalar_Tensor_out(Scalar self, Tensor other, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("random.from_out(Tensor self, int from, int? to, *, Generator? generator=None, Tensor(a!) out) -> Tensor(a!)", tags_16);
  m.def("random.from(Tensor self, int from, int? to, *, Generator? generator=None) -> Tensor", tags_16);
  m.def("random.to_out(Tensor self, int to, *, Generator? generator=None, Tensor(a!) out) -> Tensor(a!)", tags_16);
  m.def("random.to(Tensor self, int to, *, Generator? generator=None) -> Tensor", tags_16);
  m.def("random.out(Tensor self, *, Generator? generator=None, Tensor(a!) out) -> Tensor(a!)", tags_16);
  m.def("random(Tensor self, *, Generator? generator=None) -> Tensor", tags_16);
  m.def("uniform.out(Tensor self, float from=0, float to=1, *, Generator? generator=None, Tensor(a!) out) -> Tensor(a!)", tags_16);
  m.def("uniform(Tensor self, float from=0, float to=1, *, Generator? generator=None) -> Tensor", tags_16);
  m.def("cauchy.out(Tensor self, float median=0, float sigma=1, *, Generator? generator=None, Tensor(a!) out) -> Tensor(a!)", tags_16);
  m.def("cauchy(Tensor self, float median=0, float sigma=1, *, Generator? generator=None) -> Tensor", tags_16);
  m.def("log_normal.out(Tensor self, float mean=1, float std=2, *, Generator? generator=None, Tensor(a!) out) -> Tensor(a!)", tags_16);
  m.def("log_normal(Tensor self, float mean=1, float std=2, *, Generator? generator=None) -> Tensor", tags_16);
  m.def("exponential.out(Tensor self, float lambd=1, *, Generator? generator=None, Tensor(a!) out) -> Tensor(a!)", tags_16);
  m.def("exponential(Tensor self, float lambd=1, *, Generator? generator=None) -> Tensor", tags_16);
  m.def("geometric.out(Tensor self, float p, *, Generator? generator=None, Tensor(a!) out) -> Tensor(a!)", tags_16);
  m.def("geometric(Tensor self, float p, *, Generator? generator=None) -> Tensor", tags_16);
  m.def("tril_indices.out(int row, int col, int offset=0, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("triu_indices.out(int row, int col, int offset=0, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("trace.out(Tensor self, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("_cholesky_solve_helper.out(Tensor self, Tensor A, bool upper, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("dist.out(Tensor self, Tensor other, Scalar p=2, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("_histogramdd_bin_edges.out(Tensor self, int[] bins, *, float[]? range=None, Tensor? weight=None, bool density=False, Tensor(a!)[] out) -> ()", tags_15);
  m.def("_histogramdd_from_bin_cts.out(Tensor self, int[] bins, *, float[]? range=None, Tensor? weight=None, bool density=False, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("_histogramdd_from_bin_tensors.out(Tensor self, Tensor[] bins, *, Tensor? weight=None, bool density=False, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("remainder.Scalar_Tensor_out(Scalar self, Tensor other, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("argsort.stable_out(Tensor self, *, bool stable, int dim=-1, bool descending=False, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("unfold_backward.out(Tensor grad_in, SymInt[] input_sizes, int dim, int size, int step, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("normal.out(Tensor self, float mean=0, float std=1, *, Generator? generator=None, Tensor(a!) out) -> Tensor(a!)", tags_16);
  m.def("_amp_foreach_non_finite_check_and_unscale.out(Tensor[] self, Tensor(b!) found_inf, Tensor inv_scale, *, Tensor(a!)[] out) -> ()", tags_15);
  m.def("_amp_foreach_non_finite_check_and_unscale(Tensor[] self, Tensor found_inf, Tensor inv_scale) -> (Tensor[] self_out, Tensor found_inf_out)", tags_15);
  m.def("_amp_update_scale.out(Tensor self, Tensor(b!) growth_tracker, Tensor found_inf, float scale_growth_factor, float scale_backoff_factor, int growth_interval, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("_amp_update_scale(Tensor self, Tensor growth_tracker, Tensor found_inf, float scale_growth_factor, float scale_backoff_factor, int growth_interval) -> (Tensor, Tensor growth_tracker_out)", tags_15);
  m.def("_foreach_add.Scalar_out(Tensor[] self, Scalar scalar, *, Tensor(a!)[] out) -> ()", tags_15);
  m.def("_foreach_add.List_out(Tensor[] self, Tensor[] other, *, Scalar alpha=1, Tensor(a!)[] out) -> ()", tags_15);
  m.def("_foreach_add.ScalarList_out(Tensor[] self, Scalar[] scalars, *, Tensor(a!)[] out) -> ()", tags_15);
  m.def("_foreach_add.Tensor_out(Tensor[] self, Tensor other, *, Scalar alpha=1, Tensor(a!)[] out) -> ()", tags_15);
  m.def("_foreach_sub.Scalar_out(Tensor[] self, Scalar scalar, *, Tensor(a!)[] out) -> ()", tags_15);
  m.def("_foreach_sub.List_out(Tensor[] self, Tensor[] other, *, Scalar alpha=1, Tensor(a!)[] out) -> ()", tags_15);
  m.def("_foreach_sub.ScalarList_out(Tensor[] self, Scalar[] scalars, *, Tensor(a!)[] out) -> ()", tags_15);
  m.def("_foreach_mul.Scalar_out(Tensor[] self, Scalar scalar, *, Tensor(a!)[] out) -> ()", tags_15);
  m.def("_foreach_mul.List_out(Tensor[] self, Tensor[] other, *, Tensor(a!)[] out) -> ()", tags_15);
  m.def("_foreach_mul.ScalarList_out(Tensor[] self, Scalar[] scalars, *, Tensor(a!)[] out) -> ()", tags_15);
  m.def("_foreach_mul.Tensor_out(Tensor[] self, Tensor other, *, Tensor(a!)[] out) -> ()", tags_15);
  m.def("_foreach_div.Scalar_out(Tensor[] self, Scalar scalar, *, Tensor(a!)[] out) -> ()", tags_15);
  m.def("_foreach_div.List_out(Tensor[] self, Tensor[] other, *, Tensor(a!)[] out) -> ()", tags_15);
  m.def("_foreach_div.ScalarList_out(Tensor[] self, Scalar[] scalars, *, Tensor(a!)[] out) -> ()", tags_15);
  m.def("_foreach_div.Tensor_out(Tensor[] self, Tensor other, *, Tensor(a!)[] out) -> ()", tags_15);
  m.def("_foreach_clamp_max.Scalar_out(Tensor[] self, Scalar scalar, *, Tensor(a!)[] out) -> ()", tags_15);
  m.def("_foreach_clamp_max.List_out(Tensor[] self, Tensor[] other, *, Tensor(a!)[] out) -> ()", tags_15);
  m.def("_foreach_clamp_max.ScalarList_out(Tensor[] self, Scalar[] scalars, *, Tensor(a!)[] out) -> ()", tags_15);
  m.def("_foreach_clamp_min.Scalar_out(Tensor[] self, Scalar scalar, *, Tensor(a!)[] out) -> ()", tags_15);
  m.def("_foreach_clamp_min.List_out(Tensor[] self, Tensor[] other, *, Tensor(a!)[] out) -> ()", tags_15);
  m.def("_foreach_clamp_min.ScalarList_out(Tensor[] self, Scalar[] scalars, *, Tensor(a!)[] out) -> ()", tags_15);
  m.def("_foreach_maximum.Scalar_out(Tensor[] self, Scalar scalar, *, Tensor(a!)[] out) -> ()", tags_15);
  m.def("_foreach_maximum.List_out(Tensor[] self, Tensor[] other, *, Tensor(a!)[] out) -> ()", tags_15);
  m.def("_foreach_maximum.ScalarList_out(Tensor[] self, Scalar[] scalars, *, Tensor(a!)[] out) -> ()", tags_15);
  m.def("_foreach_minimum.Scalar_out(Tensor[] self, Scalar scalar, *, Tensor(a!)[] out) -> ()", tags_15);
  m.def("_foreach_minimum.List_out(Tensor[] self, Tensor[] other, *, Tensor(a!)[] out) -> ()", tags_15);
  m.def("_foreach_minimum.ScalarList_out(Tensor[] self, Scalar[] scalars, *, Tensor(a!)[] out) -> ()", tags_15);
  m.def("_foreach_addcdiv.Scalar_out(Tensor[] self, Tensor[] tensor1, Tensor[] tensor2, Scalar value=1, *, Tensor(a!)[] out) -> ()", tags_15);
  m.def("_foreach_addcdiv.ScalarList_out(Tensor[] self, Tensor[] tensor1, Tensor[] tensor2, Scalar[] scalars, *, Tensor(a!)[] out) -> ()", tags_15);
  m.def("_foreach_addcdiv.Tensor_out(Tensor[] self, Tensor[] tensor1, Tensor[] tensor2, Tensor scalars, *, Tensor(a!)[] out) -> ()", tags_15);
  m.def("_foreach_addcmul.Scalar_out(Tensor[] self, Tensor[] tensor1, Tensor[] tensor2, Scalar value=1, *, Tensor(a!)[] out) -> ()", tags_15);
  m.def("_foreach_addcmul.ScalarList_out(Tensor[] self, Tensor[] tensor1, Tensor[] tensor2, Scalar[] scalars, *, Tensor(a!)[] out) -> ()", tags_15);
  m.def("_foreach_addcmul.Tensor_out(Tensor[] self, Tensor[] tensor1, Tensor[] tensor2, Tensor scalars, *, Tensor(a!)[] out) -> ()", tags_15);
  m.def("_foreach_abs.out(Tensor[] self, *, Tensor(a!)[] out) -> ()", tags_15);
  m.def("_foreach_acos.out(Tensor[] self, *, Tensor(a!)[] out) -> ()", tags_15);
  m.def("_foreach_asin.out(Tensor[] self, *, Tensor(a!)[] out) -> ()", tags_15);
  m.def("_foreach_atan.out(Tensor[] self, *, Tensor(a!)[] out) -> ()", tags_15);
  m.def("_foreach_ceil.out(Tensor[] self, *, Tensor(a!)[] out) -> ()", tags_15);
  m.def("_foreach_cos.out(Tensor[] self, *, Tensor(a!)[] out) -> ()", tags_15);
  m.def("_foreach_cosh.out(Tensor[] self, *, Tensor(a!)[] out) -> ()", tags_15);
  m.def("_foreach_erf.out(Tensor[] self, *, Tensor(a!)[] out) -> ()", tags_15);
  m.def("_foreach_erfc.out(Tensor[] self, *, Tensor(a!)[] out) -> ()", tags_15);
  m.def("_foreach_exp.out(Tensor[] self, *, Tensor(a!)[] out) -> ()", tags_15);
  m.def("_foreach_expm1.out(Tensor[] self, *, Tensor(a!)[] out) -> ()", tags_15);
  m.def("_foreach_floor.out(Tensor[] self, *, Tensor(a!)[] out) -> ()", tags_15);
  m.def("_foreach_frac.out(Tensor[] self, *, Tensor(a!)[] out) -> ()", tags_15);
  m.def("_foreach_lerp.List_out(Tensor[] self, Tensor[] tensors1, Tensor[] weights, *, Tensor(a!)[] out) -> ()", tags_15);
  m.def("_foreach_lerp.Scalar_out(Tensor[] self, Tensor[] tensors1, Scalar weight, *, Tensor(a!)[] out) -> ()", tags_15);
  m.def("_foreach_lgamma.out(Tensor[] self, *, Tensor(a!)[] out) -> ()", tags_15);
  m.def("_foreach_log.out(Tensor[] self, *, Tensor(a!)[] out) -> ()", tags_15);
  m.def("_foreach_log10.out(Tensor[] self, *, Tensor(a!)[] out) -> ()", tags_15);
  m.def("_foreach_log1p.out(Tensor[] self, *, Tensor(a!)[] out) -> ()", tags_15);
  m.def("_foreach_log2.out(Tensor[] self, *, Tensor(a!)[] out) -> ()", tags_15);
  m.def("_foreach_neg.out(Tensor[] self, *, Tensor(a!)[] out) -> ()", tags_15);
  m.def("_foreach_norm.Scalar_out(Tensor[] self, Scalar ord=2, *, Tensor(a!)[] out) -> ()", tags_15);
  m.def("_foreach_pow.List_out(Tensor[] self, Tensor[] exponent, *, Tensor(a!)[] out) -> ()", tags_15);
  m.def("_foreach_pow.Scalar_out(Tensor[] self, Scalar exponent, *, Tensor(a!)[] out) -> ()", tags_15);
  m.def("_foreach_pow.ScalarList_out(Tensor[] self, Scalar[] exponent, *, Tensor(a!)[] out) -> ()", tags_15);
  m.def("_foreach_reciprocal.out(Tensor[] self, *, Tensor(a!)[] out) -> ()", tags_15);
  m.def("_foreach_round.out(Tensor[] self, *, Tensor(a!)[] out) -> ()", tags_15);
  m.def("_foreach_sigmoid.out(Tensor[] self, *, Tensor(a!)[] out) -> ()", tags_15);
  m.def("_foreach_sign.out(Tensor[] self, *, Tensor(a!)[] out) -> ()", tags_15);
  m.def("_foreach_sin.out(Tensor[] self, *, Tensor(a!)[] out) -> ()", tags_15);
  m.def("_foreach_sinh.out(Tensor[] self, *, Tensor(a!)[] out) -> ()", tags_15);
  m.def("_foreach_sqrt.out(Tensor[] self, *, Tensor(a!)[] out) -> ()", tags_15);
  m.def("_foreach_tan.out(Tensor[] self, *, Tensor(a!)[] out) -> ()", tags_15);
  m.def("_foreach_tanh.out(Tensor[] self, *, Tensor(a!)[] out) -> ()", tags_15);
  m.def("_foreach_trunc.out(Tensor[] self, *, Tensor(a!)[] out) -> ()", tags_15);
  m.def("_foreach_zero.out(Tensor[] self, *, Tensor(a!)[] out) -> ()", tags_15);
  m.def("_foreach_zero(Tensor[] self) -> Tensor[] self_out", tags_15);
  m.def("_foreach_copy.out(Tensor[] self, Tensor[] src, bool non_blocking=False, *, Tensor(a!)[] out) -> ()", tags_15);
  m.def("_foreach_copy(Tensor[] self, Tensor[] src, bool non_blocking=False) -> Tensor[] self_out", tags_15);
  m.def("bucketize.Scalar_out(Scalar self, Tensor boundaries, *, bool out_int32=False, bool right=False, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("glu_jvp.out(Tensor glu, Tensor x, Tensor dx, int dim, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("glu_backward_jvp.out(Tensor grad_x, Tensor grad_glu, Tensor x, Tensor dgrad_glu, Tensor dx, int dim, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("hardswish_backward.out(Tensor grad_output, Tensor self, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("rrelu_with_noise_backward.out(Tensor grad_output, Tensor self, Tensor noise, Scalar lower, Scalar upper, bool training, bool self_is_result, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("mkldnn_adaptive_avg_pool2d_backward.out(Tensor grad_output, Tensor self, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("_adaptive_avg_pool2d.out(Tensor self, SymInt[2] output_size, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("_adaptive_avg_pool2d_backward.out(Tensor grad_output, Tensor self, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("_adaptive_avg_pool3d.out(Tensor self, SymInt[3] output_size, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("_adaptive_avg_pool3d_backward.out(Tensor grad_output, Tensor self, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("_slow_conv2d_backward.output_mask_out(Tensor grad_output, Tensor self, Tensor weight, SymInt[2] kernel_size, SymInt[2] stride, SymInt[2] padding, bool[3] output_mask, *, Tensor(a!) out0, Tensor(b!) out1, Tensor(c!) out2) -> (Tensor(a!), Tensor(b!), Tensor(c!))", tags_15);
  m.def("conv_depthwise3d.out(Tensor self, Tensor weight, SymInt[3] kernel_size, Tensor? bias, SymInt[3] stride, SymInt[3] padding, SymInt[3] dilation, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("slow_conv_dilated2d.out(Tensor self, Tensor weight, SymInt[2] kernel_size, Tensor? bias=None, SymInt[2] stride=1, SymInt[2] padding=0, SymInt[2] dilation=1, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("slow_conv_dilated3d.out(Tensor self, Tensor weight, SymInt[3] kernel_size, Tensor? bias=None, SymInt[3] stride=1, SymInt[3] padding=0, SymInt[3] dilation=1, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("isinf.out(Tensor self, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("linalg_matrix_exp.out(Tensor self, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("_test_optional_intlist.out(Tensor values, int[]? addends, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("_test_optional_filled_intlist.out(Tensor values, int[2]? addends, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("_test_optional_floatlist.out(Tensor values, float[]? addends, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("_test_warn_in_autograd.out(Tensor self, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("_test_autograd_multiple_dispatch.fullcoverage_out(Tensor self, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("_test_autograd_multiple_dispatch_view_copy.out(Tensor self, *, Tensor(a!) out) -> Tensor(a!)", tags_17);
  m.def("segment_reduce.out(Tensor data, str reduce, *, Tensor? lengths=None, Tensor? indices=None, Tensor? offsets=None, int axis=0, bool unsafe=False, Scalar? initial=None, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("_segment_reduce_backward.out(Tensor grad, Tensor output, Tensor data, str reduce, *, Tensor? lengths=None, Tensor? offsets=None, int axis=0, Scalar? initial=None, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("_nested_tensor_from_tensor_list.out(Tensor[] list, ScalarType? dtype=None, Layout? layout=None, Device? device=None, bool? pin_memory=None, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("_fw_primal_copy.out(Tensor self, int level, *, Tensor(a!) out) -> Tensor(a!)", tags_17);
  m.def("_make_dual_copy.out(Tensor primal, Tensor tangent, int level, *, Tensor(a!) out) -> Tensor(a!)", tags_17);
  m.def("view_as_real_copy.out(Tensor self, *, Tensor(a!) out) -> Tensor(a!)", tags_17);
  m.def("view_as_complex_copy.out(Tensor self, *, Tensor(a!) out) -> Tensor(a!)", tags_17);
  m.def("_conj_copy.out(Tensor self, *, Tensor(a!) out) -> Tensor(a!)", tags_17);
  m.def("_neg_view_copy.out(Tensor self, *, Tensor(a!) out) -> Tensor(a!)", tags_17);
  m.def("as_strided_copy.out(Tensor self, SymInt[] size, SymInt[] stride, SymInt? storage_offset=None, *, Tensor(a!) out) -> Tensor(a!)", tags_17);
  m.def("_sparse_broadcast_to_copy.out(Tensor self, int[] size, *, Tensor(a!) out) -> Tensor(a!)", tags_17);
  m.def("diagonal_copy.out(Tensor self, int offset=0, int dim1=0, int dim2=1, *, Tensor(a!) out) -> Tensor(a!)", tags_17);
  m.def("expand_copy.out(Tensor self, SymInt[] size, *, bool implicit=False, Tensor(a!) out) -> Tensor(a!)", tags_17);
  m.def("permute_copy.out(Tensor self, int[] dims, *, Tensor(a!) out) -> Tensor(a!)", tags_17);
  m.def("_reshape_alias_copy.out(Tensor self, SymInt[] size, SymInt[] stride, *, Tensor(a!) out) -> Tensor(a!)", tags_17);
  m.def("select_copy.int_out(Tensor self, int dim, SymInt index, *, Tensor(a!) out) -> Tensor(a!)", tags_17);
  m.def("detach_copy.out(Tensor self, *, Tensor(a!) out) -> Tensor(a!)", tags_17);
  m.def("slice_copy.Tensor_out(Tensor self, int dim=0, SymInt? start=None, SymInt? end=None, SymInt step=1, *, Tensor(a!) out) -> Tensor(a!)", tags_17);
  m.def("squeeze_copy.out(Tensor self, *, Tensor(a!) out) -> Tensor(a!)", tags_17);
  m.def("squeeze_copy.dim_out(Tensor self, int dim, *, Tensor(a!) out) -> Tensor(a!)", tags_17);
  m.def("squeeze_copy.dims_out(Tensor self, int[] dim, *, Tensor(a!) out) -> Tensor(a!)", tags_17);
  m.def("t_copy.out(Tensor self, *, Tensor(a!) out) -> Tensor(a!)", tags_17);
  m.def("transpose_copy.int_out(Tensor self, int dim0, int dim1, *, Tensor(a!) out) -> Tensor(a!)", tags_17);
  m.def("unsqueeze_copy.out(Tensor self, int dim, *, Tensor(a!) out) -> Tensor(a!)", tags_17);
  m.def("_indices_copy.out(Tensor self, *, Tensor(a!) out) -> Tensor(a!)", tags_17);
  m.def("_values_copy.out(Tensor self, *, Tensor(a!) out) -> Tensor(a!)", tags_17);
  m.def("indices_copy.out(Tensor self, *, Tensor(a!) out) -> Tensor(a!)", tags_17);
  m.def("values_copy.out(Tensor self, *, Tensor(a!) out) -> Tensor(a!)", tags_17);
  m.def("crow_indices_copy.out(Tensor self, *, Tensor(a!) out) -> Tensor(a!)", tags_17);
  m.def("col_indices_copy.out(Tensor self, *, Tensor(a!) out) -> Tensor(a!)", tags_17);
  m.def("ccol_indices_copy.out(Tensor self, *, Tensor(a!) out) -> Tensor(a!)", tags_17);
  m.def("row_indices_copy.out(Tensor self, *, Tensor(a!) out) -> Tensor(a!)", tags_17);
  m.def("view_copy.out(Tensor self, SymInt[] size, *, Tensor(a!) out) -> Tensor(a!)", tags_17);
  m.def("view_copy.dtype_out(Tensor self, ScalarType dtype, *, Tensor(a!) out) -> Tensor(a!)", tags_17);
  m.def("unfold_copy.out(Tensor self, int dimension, int size, int step, *, Tensor(a!) out) -> Tensor(a!)", tags_17);
  m.def("alias_copy.out(Tensor self, *, Tensor(a!) out) -> Tensor(a!)", tags_17);
  m.def("to_padded_tensor.out(Tensor self, float padding, SymInt[]? output_size=None, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("_transformer_encoder_layer_fwd.out(Tensor src, int embed_dim, int num_heads, Tensor qkv_weight, Tensor qkv_bias, Tensor proj_weight, Tensor proj_bias, bool use_gelu, bool norm_first, float eps, Tensor norm_weight_1, Tensor norm_bias_1, Tensor norm_weight_2, Tensor norm_bias_2, Tensor ffn_weight_1, Tensor ffn_bias_1, Tensor ffn_weight_2, Tensor ffn_bias_2, Tensor? mask=None, int? mask_type=None, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  ...
  m.def("_triton_scaled_dot_attention.out(Tensor q, Tensor k, Tensor v, float dropout_p=0.0, *, Tensor(a!) out) -> Tensor(a!)", tags_16);
  m.def("_triton_multi_head_attention.out(Tensor query, Tensor key, Tensor value, int embed_dim, int num_head, Tensor qkv_weight, Tensor qkv_bias, Tensor proj_weight, Tensor proj_bias, Tensor? mask=None, *, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("_foobar.out(Tensor self, bool arg1=True, bool arg2=True, *, bool arg3=True, Tensor(a!) out) -> Tensor(a!)", tags_15);
  m.def("_fused_adam.out(Tensor[] self, Tensor(b!)[] grads, Tensor(c!)[] exp_avgs, Tensor(d!)[] exp_avg_sqs, Tensor(e!)[] max_exp_avg_sqs, Tensor[] state_steps, *, float lr, float beta1, float beta2, float weight_decay, float eps, bool amsgrad, bool maximize, Tensor? grad_scale=None, Tensor? found_inf=None, Tensor(a!)[] out) -> ()", tags_15);
  m.def("_fused_adam(Tensor[] self, Tensor[] grads, Tensor[] exp_avgs, Tensor[] exp_avg_sqs, Tensor[] max_exp_avg_sqs, Tensor[] state_steps, *, float lr, float beta1, float beta2, float weight_decay, float eps, bool amsgrad, bool maximize, Tensor? grad_scale=None, Tensor? found_inf=None) -> (Tensor[] self_out, Tensor[] grads_out, Tensor[] exp_avgs_out, Tensor[] exp_avg_sqs_out, Tensor[] max_exp_avg_sqs_out)", tags_15);
  m.def("_fused_adam.tensor_lr_out(Tensor[] self, Tensor(b!)[] grads, Tensor(c!)[] exp_avgs, Tensor(d!)[] exp_avg_sqs, Tensor(e!)[] max_exp_avg_sqs, Tensor[] state_steps, *, Tensor lr, float beta1, float beta2, float weight_decay, float eps, bool amsgrad, bool maximize, Tensor? grad_scale=None, Tensor? found_inf=None, Tensor(a!)[] out) -> ()", tags_15);
  ...
  m.def("_fused_adamw.out(Tensor[] self, Tensor(b!)[] grads, Tensor(c!)[] exp_avgs, Tensor(d!)[] exp_avg_sqs, Tensor(e!)[] max_exp_avg_sqs, Tensor[] state_steps, *, float lr, float beta1, float beta2, float weight_decay, float eps, bool amsgrad, bool maximize, Tensor? grad_scale=None, Tensor? found_inf=None, Tensor(a!)[] out) -> ()", tags_15);
  ...
  m.def("_fused_adamw.tensor_lr_out(Tensor[] self, Tensor(b!)[] grads, Tensor(c!)[] exp_avgs, Tensor(d!)[] exp_avg_sqs, Tensor(e!)[] max_exp_avg_sqs, Tensor[] state_steps, *, Tensor lr, float beta1, float beta2, float weight_decay, float eps, bool amsgrad, bool maximize, Tensor? grad_scale=None, Tensor? found_inf=None, Tensor(a!)[] out) -> ()", tags_15);
  ...
  m.def("_fused_sgd.out(Tensor[] self, Tensor(b!)[] grads, Tensor(c!)[] momentum_buffer_list, *, float weight_decay, float momentum, float lr, float dampening, bool nesterov, bool maximize, bool is_first_step, Tensor? grad_scale=None, Tensor? found_inf=None, Tensor(a!)[] out) -> ()", tags_15);
  m.def("_fused_sgd(Tensor[] self, Tensor[] grads, Tensor[] momentum_buffer_list, *, float weight_decay, float momentum, float lr, float dampening, bool nesterov, bool maximize, bool is_first_step, Tensor? grad_scale=None, Tensor? found_inf=None) -> (Tensor[] self_out, Tensor[] grads_out, Tensor[] momentum_buffer_list_out)", tags_15);
  m.def("_fused_sgd.tensor_lr_out(Tensor[] self, Tensor(b!)[] grads, Tensor(c!)[] momentum_buffer_list, *, float weight_decay, float momentum, Tensor lr, float dampening, bool nesterov, bool maximize, bool is_first_step, Tensor? grad_scale=None, Tensor? found_inf=None, Tensor(a!)[] out) -> ()", tags_15);
  m.def("_fused_sgd.tensor_lr(Tensor[] self, Tensor[] grads, Tensor[] momentum_buffer_list, *, float weight_decay, float momentum, Tensor lr, float dampening, bool nesterov, bool maximize, bool is_first_step, Tensor? grad_scale=None, Tensor? found_inf=None) -> (Tensor[] self_out, Tensor[] grads_out, Tensor[] momentum_buffer_list_out)", tags_15);;
  // Distributed Ops
