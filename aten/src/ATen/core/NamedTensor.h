...
// non-wildcard
struct NamedTensorMeta final : public c10::NamedTensorMetaInterface {
...
const TensorBase& internal_set_names_inplace(const TensorBase& tensor, c10::optional<DimnameList> names);
...
void internal_set_names_inplace(TensorImpl* impl, c10::optional<DimnameList> names, bool validate_names);
...
c10::optional<DimnameList> get_opt_names(const TensorImpl* impl);
