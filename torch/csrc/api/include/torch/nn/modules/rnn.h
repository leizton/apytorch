...
/// ```
class RNNCellImpl : public detail::RNNCellImplBase<RNNCellImpl> {
 public:
...
/// ```
class LSTMCellImpl : public detail::RNNCellImplBase<LSTMCellImpl> {
 public:
...
/// ```
class GRUCellImpl : public detail::RNNCellImplBase<GRUCellImpl> {
 public:
