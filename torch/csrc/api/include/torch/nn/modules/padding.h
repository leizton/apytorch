...
class ZeroPad1dImpl : public ZeroPadImpl<1, ZeroPad1dImpl> {
 public:
...
class ZeroPad2dImpl : public ZeroPadImpl<2, ZeroPad2dImpl> {
 public:
...
class ZeroPad3dImpl : public ZeroPadImpl<3, ZeroPad3dImpl> {
 public:
