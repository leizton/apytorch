...
class ScriptRRefFetchCall final : public RRefMessageBase {
 public:
...
class RRefFetchRet : public RpcCommandBase {
 public:
...
class ScriptRRefFetchRet final : public RRefFetchRet {
 public:
...
class PythonRRefFetchRet final : public RRefFetchRet {
 public:
