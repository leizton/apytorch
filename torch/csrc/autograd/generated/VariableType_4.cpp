...
at::Tensor sparse_compressed_tensor_comp_plain_value_size(c10::DispatchKeySet ks, const at::Tensor & compressed_indices, const at::Tensor & plain_indices, const at::Tensor & values, at::IntArrayRef size, c10::optional<at::ScalarType> dtype, c10::optional<at::Layout> layout, c10::optional<at::Device> device, c10::optional<bool> pin_memory) {
  ...
  auto _tmp = ([&]() {
    if ((isFwGradDefined(values))) {
      ...
      at::AutoDispatchBelowADInplaceOrView guard;
      return at::redispatch::sparse_compressed_tensor(ks & c10::after_autograd_keyset, compressed_indices_, plain_indices_, values_, size, dtype, layout, device, pin_memory);
    }
  })();
  auto result = std::move(_tmp);
  #ifndef NDEBUG
